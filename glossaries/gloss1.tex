...
\begin{test}{TEST 4}
\noindent
\textbf{Part 1. Daily Routine}

\begin{qa}{What would you like to change in your daily routine?}
Speaking of routines, there are a number of daily ones I'd like to change. The first thing that \textbf{crosses my mind} is the fact that I frequently stay up late at night. To be frank, I'm \textbf{a night owl}. In particular, I hardly \textbf{turn in} before midnight, which I believe does harm to my health. I have \textbf{made some attempts} at getting up early to \textbf{hit the gym} but due to my sleeping late, it was such a \textbf{mountain to climb} for me.
\end{qa}

\begin{qa}{Are all your days the same?}
Probably. Each weekday \textbf{follows a similar pattern}. In particular, I am \textbf{under obligations} to wake up early then I am off to work. Then I come back home, maybe I'll handle some extra work then I am home again socializing with my family. On weekends, I am \textbf{in the habit of lying in} and going somewhere else for \textbf{a change of pace}.
\end{qa}
...
\begin{VocabExplain}[Part 1]
  ...
  \EN{(Of a thought) to occur to someone, often briefly or unexpectedly.}
  \SY{Occur to, come to mind, spring to mind.}
  \VI{(Ý nghĩ) thoáng/nảy ra trong đầu.}
  \EX{It never crossed my mind that the email was a scam.}
  \EX{The solution finally crossed her mind on the train home.}
  \CO{it never/rarely crosses my mind that \dots; the thought crossed my mind; what crossed your mind?}
\end{ExplainCard}

\begin{ExplainCard}{to be frank}[phrase][B2]
  \EN{Used to introduce an honest or direct opinion, even if it may be unpleasant.}
  \SY{Frankly, to be honest, truth be told.}
  \VI{Thực lòng mà nói; nói thẳng.}
  \EX{To be frank, the proposal isn’t ready for review.}
  \EX{To be frank with you, I prefer a smaller team.}
  \CO{to be frank (with you/about sth); frankly speaking}
\end{ExplainCard}

\begin{ExplainCard}{night owl}[idiom][B2]
  \EN{A person who habitually stays up late and is more active or productive at night.}
  \SY{Late bird (infml), not a morning person; \textit{opp.} early bird/lark.}
  \VI{Người hay thức khuya; hoạt động về đêm.}
  \EX{He’s a night owl who writes best after midnight.}
  \EX{Night-owl habits can disrupt circadian rhythms.}
  \CO{a real/typical night owl; night-owl habits/tendencies}
\end{ExplainCard}

\begin{ExplainCard}{turn in}[phrasal verb][B2]
  \EN{(1) \textbf{Turn in} (for the night): go to bed. (2) Submit work. (3) Inform on/deliver to authorities. (4) Produce or perform (esp. AmE).}
  \SY{(1) Retire (for the night); (2) hand in; (3) report; (4) deliver.}
  \VI{(1) Đi ngủ. (2) Nộp. (3) Giao nộp/tố giác. (4) Thể hiện/đạt (thành tích).}
  \EX{(1) I usually turn in around eleven.}
  \EX{(2) Please turn in your assignment by Friday.}
  \EX{(4) The striker turned in a superb performance.}
  \CO{turn in early/late; turn in homework/a report; turn sb in to the police; turn in a performance}
\end{ExplainCard}

\begin{ExplainCard}{make an attempt at \textit{V-ing} / to \textit{V}}[phrase][B2]
  \EN{To try to do something; to make an effort to achieve it.}
  \SY{Try, endeavor, take a stab at.}
  \VI{Cố gắng/thử làm điều gì.}
  \EX{She made an attempt at getting up earlier every day.}
  \EX{Scientists are making attempts to reduce battery costs.}
  \CO{make a serious/valiant attempt; an attempt at reform/solving the problem; attempt to do sth}
\end{ExplainCard}

\begin{ExplainCard}{hit the gym}[idiom][B2]
  \EN{To go to the gym to work out.}
  \SY{Work out, head to the gym, get a workout in.}
  \VI{Đến phòng gym tập luyện.}
  \EX{I usually hit the gym after work.}
  \EX{Athletes hit the gym early to build strength.}
  \CO{regularly/frequently hit the gym; hit the gym after/before work}
\end{ExplainCard}

\begin{ExplainCard}{a mountain to climb}[idiom][C1]
  \EN{A very difficult task or challenge to overcome.}
  \SY{Uphill battle, daunting task, steep challenge.}
  \VI{Một việc/thử thách vô cùng khó khăn.}
  \EX{Securing funding is still a mountain to climb.}
  \EX{The team knows they have a mountain to climb in the finals.}
  \CO{face/have a mountain to climb; a huge/steep mountain to climb}
\end{ExplainCard}

\begin{ExplainCard}{follow a similar pattern}[phrase][B2]
  \EN{To happen or develop in much the same way as something else.}
  \SY{Mirror, echo, track, resemble.}
  \VI{Diễn ra/phát triển theo khuôn mẫu tương tự.}
  \EX{Sales this quarter follow a similar pattern to last year’s.}
  \EX{Language acquisition often follows a similar pattern across cultures.}
  \CO{follow a similar/the same pattern/trajectory/trend; broadly follow the pattern}
\end{ExplainCard}

\begin{ExplainCard}{under an obligation (to do sth)}[phrase][C1]
  \EN{Required or bound (morally/legally) to do something; \textit{also} \textbf{under no obligation}.}
  \SY{Bound, obliged, compelled (by duty/law).}
  \VI{Có nghĩa vụ/phải làm (hoặc \textit{không} có nghĩa vụ).}
  \EX{Employees are under an obligation to keep data confidential.}
  \EX{You are under no obligation to accept the offer.}
  \CO{be/feel under an obligation to; legal/contractual obligations; under no obligation}
\end{ExplainCard}

\begin{ExplainCard}{be in the habit of}[phrase][B2]
  \EN{To do something regularly or routinely.}
  \SY{Be accustomed to, have a habit of.}
  \VI{Có thói quen làm gì.}
  \EX{I’m in the habit of reading before bed.}
  \EX{He’s in the habit of checking emails first thing.}
  \CO{be in the habit of doing sth; break/form a habit}
\end{ExplainCard}

\begin{ExplainCard}{lie in}[phrasal verb][B2]
  \EN{(1) To stay in bed later than usual. (2) (\textit{rare/dated}) To remain in bed during/after childbirth (lying-in).}
  \SY{(1) Sleep in, have a lie-in (BrE).}
  \VI{(1) Ngủ nướng. (2) (Cũ) Nằm dưỡng sau sinh.}
  \EX{We like to lie in on Sundays.}
  \EX{I had a long lie-in after the night shift.}
  \CO{have/take a lie-in; lie in till/until \dots}
\end{ExplainCard}

\begin{ExplainCard}{(for) a change of pace}[phrase][B2]
  \EN{A variation in routine or activity to make things feel different.}
  \SY{A change of scene, variety, break in routine.}
  \VI{Đổi gió; thay đổi nhịp độ.}
  \EX{Let’s take a walk for a change of pace.}
  \EX{She switched to design work for a change of pace.}
  \CO{for/as a change of pace; need/seek a change of pace}
\end{ExplainCard}

\begin{ExplainCard}{chow down (on sth)}[phrasal verb][B2]
  \EN{(Informal, esp. AmE) To eat enthusiastically.}
  \SY{Tuck into (BrE), dig in, devour, eat.}
  \VI{(Khẩu ngữ) Ăn ngon lành, chén nhiệt tình.}
  \EX{We chowed down on noodles after the game.}
  \EX{Everyone chowed down as soon as the food arrived.}
  \CO{chow down on pizza/burgers/street food; sit down and chow down}
\end{ExplainCard}

\begin{ExplainCard}{call it a day}[idiom][B2]
  \EN{To stop working or stop an activity for the day.}
  \SY{Wrap up, knock off (BrE), quit for the day.}
  \VI{Tạm nghỉ/kết thúc công việc trong ngày.}
  \EX{It’s 7 p.m.—let’s call it a day.}
  \EX{After three failed runs, the team called it a day.}
  \CO{let’s call it a day/night; decide to call it a day}
\end{ExplainCard}

\begin{ExplainCard}{indulge (yourself) in sth}[v][C1]
  \EN{To allow yourself to enjoy something (often seen as a luxury or not entirely necessary).}
  \SY{Treat yourself, luxuriate in, revel in.}
  \VI{Tự cho phép bản thân hưởng/thỏa thích điều gì.}
  \EX{We indulged in a long brunch after the exam.}
  \EX{She occasionally indulges herself with a spa day.}
  \CO{indulge in dessert/shopping/gaming; indulge yourself with sth; self-indulgence}
\end{ExplainCard}

\begin{ExplainCard}{grab a bite}[idiom][B2]
  \EN{To get something to eat, especially quickly or informally.}
  \SY{Have a bite, grab a quick meal, get some food.}
  \VI{Đi ăn nhanh; kiếm gì lót dạ.}
  \EX{Let’s grab a bite before the meeting.}
  \EX{We grabbed a bite at a café near campus.}
  \CO{grab a bite/lunch/dinner; grab a quick bite to eat}
\end{ExplainCard}

\begin{ExplainCard}{be flush (with cash/money)}[adj][C1]
  \EN{(1) Having plenty of money; well supplied. (2) \textit{Also} “flush with” = level/even with a surface (tech.).}
  \SY{(1) Loaded (infml), well-off; (2) level, even.}
  \VI{(1) Dư dả tiền bạc. (2) Bằng phẳng, đồng mức (kỹ thuật).}
  \EX{We’re not exactly flush this month.}
  \EX{After the bonus, the team was flush with cash.}
  \EX{The panel should be flush with the wall.}
  \CO{be/feel flush (with cash); not be flush; sit/fit flush with}
\end{ExplainCard}

\begin{ExplainCard}{burn the candle at both ends}[idiom][C1]
  \EN{To exhaust oneself by staying up late and getting up early, especially to work or study.}
  \SY{Overwork, overextend oneself, push oneself too hard.}
  \VI{Làm việc ngày đêm/qua sức.}
  \EX{He burned the candle at both ends during finals week.}
  \EX{Burning the candle at both ends can harm your health.}
  \CO{tend to burn the candle at both ends; stop/avoid burning the candle at both ends}
\end{ExplainCard}
\end{VocabExplain}
...
\begin{VocabExplain}[Part 2]
    \begin{ExplainCard}{of utmost importance}[phrase][C1]
  \EN{Of the greatest possible importance; more important than anything else.}
  \SY{Paramount, vital, crucial, of prime importance.}
  \VI{Vô cùng quan trọng; quan trọng bậc nhất.}
  \EX{Patient safety is of utmost importance in clinical trials.}
  \EX{Protecting wetlands is of utmost importance for biodiversity.}
  \CO{be of utmost/paramount importance; a matter of utmost importance; consider/deem sth of utmost importance}
\end{ExplainCard}

\begin{ExplainCard}{promotional campaign}[phrase][B2]
  \EN{A coordinated set of marketing activities designed to publicize a product or service and boost sales or awareness.}
  \SY{Marketing campaign, sales promotion, push.}
  \VI{Chiến dịch quảng bá nhằm tăng nhận biết/bán hàng.}
  \EX{The company launched a promotional campaign ahead of the holiday season.}
  \EX{Digital ads formed the core of the promotional campaign.}
  \CO{launch/run a promotional campaign; nationwide/online campaign; seasonal/back-to-school campaign}
\end{ExplainCard}

\begin{ExplainCard}{behemoth}[n][C1]
  \EN{(1) Something very large and powerful, especially a company or organization. (2) \textit{Literary} A huge creature or thing.}
  \SY{Giant, colossus, titan, leviathan.}
  \VI{(1) “Gã khổng lồ” (tổ chức/công ty). (2) Vật/sinh vật khổng lồ.}
  \EX{The search-engine behemoth dominates online advertising.}
  \EX{The merger would create a financial behemoth.}
  \CO{tech/retail/media behemoth; industry behemoth; a corporate behemoth}
\end{ExplainCard}

\begin{ExplainCard}{slash prices}[phrase][B2]
  \EN{To reduce prices by a large amount, often suddenly.}
  \SY{Cut, drop, mark down, discount heavily.}
  \VI{Giảm giá mạnh; hạ giá sâu.}
  \EX{Retailers slashed prices to clear inventory.}
  \EX{Airlines slashed ticket prices during the off-season.}
  \CO{slash prices/costs/spending; deep price cuts; heavily discounted items}
\end{ExplainCard}

\begin{ExplainCard}{increase the volume of sales}[phrase][B2]
  \EN{To raise the number of units sold; to boost sales volume.}
  \SY{Boost/drive sales, grow sales volume.}
  \VI{Tăng số lượng bán ra; đẩy mạnh doanh số.}
  \EX{Bundling accessories helped increase the volume of sales.}
  \EX{Loyalty programs can significantly increase sales volume.}
  \CO{increase/boost/drive sales volume; higher/lower volume of sales; volume-driven growth}
\end{ExplainCard}

\begin{ExplainCard}{on a tight budget}[idiom][B2]
  \EN{Having only a small amount of money to spend; needing to avoid overspending.}
  \SY{On a shoestring, short on cash, budget-conscious.}
  \VI{Ngân sách eo hẹp.}
  \EX{Students on a tight budget often cook at home.}
  \EX{We renovated the lab on a tight budget.}
  \CO{live/work on a tight budget; operate on a shoestring; plan/manage a tight budget}
\end{ExplainCard}

\begin{ExplainCard}{execute transactions}[phrase][C1]
  \EN{To carry out purchases, payments, or trades, typically via a bank or online platform.}
  \SY{Process, carry out, complete, settle.}
  \VI{Thực hiện/khớp lệnh giao dịch (mua bán, thanh toán).}
  \EX{The app lets users execute transactions securely.}
  \EX{Brokers execute transactions on behalf of clients.}
  \CO{execute/process/settle a transaction/order/payment; real-time/secure transactions}
\end{ExplainCard}

\begin{ExplainCard}{wind down}[phrasal verb][B2]
  \EN{(1) To relax after activity or stress. (2) To gradually reduce activity and come to an end.}
  \SY{(1) Unwind, decompress; (2) phase out, scale down.}
  \VI{(1) Thư giãn. (2) Thu hẹp dần, kết thúc.}
  \EX{(1) She reads to wind down before bed.}
  \EX{(2) The project will wind down next quarter.}
  \CO{wind down after work; wind down operations/production; a winding-down period}
\end{ExplainCard}

\begin{ExplainCard}{wound up}[adj][B2]
  \EN{Very tense, nervous, or excited (often from stress).}
  \SY{Tense, on edge, keyed up, stressed.}
  \VI{Căng thẳng, bồn chồn.}
  \EX{He gets wound up before presentations.}
  \EX{After the deadline, everyone was still wound up.}
  \CO{feel/get/become wound up; highly/extremely wound up; wind sb up (make sb tense/annoyed)}
\end{ExplainCard}

\begin{ExplainCard}{get a load off (one’s) mind}[idiom][B2]
  \EN{To relieve worry or stress, especially by saying something or resolving a problem.}
  \SY{Get sth off one’s chest, ease one’s mind, find relief.}
  \VI{Trút bỏ gánh nặng/giảm lo trong lòng.}
  \EX{Talking to a counselor helped her get a load off her mind.}
  \EX{Finishing the paperwork was a load off my mind.}
  \CO{be a load off my/your mind; get sth off your chest; ease/settle sb’s mind}
\end{ExplainCard}

\begin{ExplainCard}{erratic work schedules}[phrase][C1]
  \EN{Work timetables that are irregular and unpredictable.}
  \SY{Irregular schedules, inconsistent shifts.}
  \VI{Lịch làm việc thất thường/khó đoán.}
  \EX{Erratic work schedules make childcare hard to arrange.}
  \EX{Shift workers with erratic schedules report poorer sleep.}
  \CO{have/work on erratic schedules; highly erratic/irregular hours; unpredictable shifts}
\end{ExplainCard}

\begin{ExplainCard}{keep up with (the) market variations}[phrase][C1]
  \EN{To stay informed about and responsive to changes in the market.}
  \SY{Stay abreast of, track, keep pace with, monitor.}
  \VI{Theo kịp/cập nhật những biến động thị trường.}
  \EX{Analysts must keep up with rapid market variations.}
  \EX{Dashboards help managers keep up with price swings.}
  \CO{keep up with trends/changes; stay abreast of market movements; track market volatility}
\end{ExplainCard}

\begin{ExplainCard}{play a pivotal role}[phrase][C1]
  \EN{To be central and essential to the success or functioning of something.}
  \SY{Be crucial/key, be instrumental, be central.}
  \VI{Đóng vai trò then chốt/quyết định.}
  \EX{Logistics plays a pivotal role in e-commerce.}
  \EX{Mentorship played a pivotal role in her career.}
  \CO{play a pivotal/key/critical role in; a pivotal role/position/factor}
\end{ExplainCard}

\begin{ExplainCard}{handy}[adj][B2]
  \EN{(1) Useful or convenient. (2) Located near and easy to reach. (3) \textit{Infml} Skillful with the hands.}
  \SY{(1) Practical, helpful; (2) close at hand; (3) deft, handy with.}
  \VI{(1) Tiện lợi, hữu ích. (2) Ở gần, dễ lấy. (3) Khéo tay.}
  \EX{(1) A pocket notebook is handy for quick ideas.}
  \EX{(2) Keep the first-aid kit handy.}
  \EX{(3) She's handy with tools.}
  \CO{come in handy; keep sth handy; handy tool/tip; be handy with a screwdriver}
\end{ExplainCard}
\end{VocabExplain}
...
\begin{VocabExplain}[Part 3]
    \begin{ExplainCard}{diverge}[v][C1]
  \EN{(1) To separate and go in different directions. (2) (Math) To fail to approach a limit; to increase without bound. (3) To differ in opinion or form.}
  \SY{(1) Split, branch, part; (3) differ, deviate.}
  \VI{(1) Tách nhánh/đi về những hướng khác nhau. (2) (Toán) Phân kỳ. (3) Khác biệt, lệch.}
  \EX{The paths diverge at the river.}
  \EX{Our views diverge on how to fund the project.}
  \CO{diverge from the norm/plan; roads/paths diverge; opinions diverge widely; a diverging trend}
\end{ExplainCard}

\begin{ExplainCard}{for the most part}[phrase][B2]
  \EN{In most cases; generally.}
  \SY{Generally, by and large, on the whole.}
  \VI{Nhìn chung; phần lớn.}
  \EX{For the most part, customers were satisfied.}
  \EX{The data, for the most part, support the hypothesis.}
  \CO{for the most part + clause; be true/accurate for the most part}
\end{ExplainCard}

\begin{ExplainCard}{indicator}[n][B2]
  \EN{(1) A sign that shows what something is like or how it is changing. (2) (Finance/Stats) A measurable variable used to assess performance.}
  \SY{Sign, measure, signal, metric.}
  \VI{(1) Dấu hiệu. (2) Chỉ số (đo lường).}
  \EX{Literacy is a key indicator of development.}
  \EX{Leading indicators suggest a slowdown ahead.}
  \CO{key/reliable indicator; economic/health/performance indicators; leading/lagging indicator}
\end{ExplainCard}

\begin{ExplainCard}{socioeconomic}[adj][C1]
  \EN{Relating to the interaction of social and economic factors.}
  \SY{Socio-economic, social-economic.}
  \VI{Thuộc về kinh tế–xã hội.}
  \EX{Socioeconomic status influences health outcomes.}
  \EX{The report maps socioeconomic disparities across regions.}
  \CO{socioeconomic status/background/inequality; socioeconomic factors/determinants}
\end{ExplainCard}

\begin{ExplainCard}{affluence}[n][C1]
  \EN{The state of having a lot of money and a high standard of living.}
  \SY{Wealth, prosperity, opulence.}
  \VI{Sự giàu có; sung túc.}
  \EX{Affluence grew rapidly during the boom years.}
  \EX{Areas of affluence exist alongside pockets of deprivation.}
  \CO{rise/growth in affluence; zones/pockets of affluence; markers of affluence}
\end{ExplainCard}

\begin{ExplainCard}{strive for}[v][C1]
  \EN{To make a great effort to achieve something.}
  \SY{Aim for, pursue, endeavor to achieve.}
  \VI{Nỗ lực phấn đấu để đạt được.}
  \EX{We strive for excellence in teaching.}
  \EX{Athletes strive for marginal gains.}
  \CO{strive for excellence/perfection/innovation; strive to improve/reduce}
\end{ExplainCard}

\begin{ExplainCard}{exception}[n][B2]
  \EN{A person or thing that is not included in a general statement or rule.}
  \SY{Anomaly, outlier, exemption.}
  \VI{Ngoại lệ.}
  \EX{Most firms grew; a few notable exceptions struggled.}
  \EX{Children under five are an exception to the rule.}
  \CO{make an exception; with/without exception; a rare/notable exception}
\end{ExplainCard}

\begin{ExplainCard}{be occupied with}[phrase][B2]
  \EN{To be busy doing or dealing with something.}
  \SY{Be engaged in, be absorbed in, be tied up with.}
  \VI{Bận rộn với.}
  \EX{She’s occupied with year-end reports.}
  \EX{Parents are often occupied with childcare duties.}
  \CO{be fully/mostly occupied with; remain occupied with tasks/work}
\end{ExplainCard}

\begin{ExplainCard}{cover (one’s) bills}[phrase][B2]
  \EN{To pay for daily expenses; to meet one’s financial obligations.}
  \SY{Pay/meet expenses, make ends meet.}
  \VI{Chi trả chi tiêu hằng ngày/hoá đơn.}
  \EX{A part-time job barely covers my bills.}
  \EX{Emergency savings helped him cover his bills during furlough.}
  \CO{cover/pay the bills; struggle to cover bills; enough to cover living costs}
\end{ExplainCard}

\begin{ExplainCard}{let alone}[phrase][C1]
  \EN{Used to emphasize that the following thing is even less likely or possible.}
  \SY{Much less, not to mention, never mind.}
  \VI{Chứ đừng nói đến/huống hồ.}
  \EX{We can’t afford a car, let alone a house.}
  \EX{He hardly has time to eat, let alone to cook.}
  \CO{can’t/hardly \dots\ let alone \dots}
\end{ExplainCard}

\begin{ExplainCard}{come into fashion}[idiom][B2]
  \EN{To become fashionable or trendy.}
  \SY{Become fashionable, be in vogue, catch on.}
  \VI{Trở thành mốt; lên ngôi.}
  \EX{Vintage styles have come into fashion again.}
  \EX{Plant-based diets have come into fashion among athletes.}
  \CO{come/go out of fashion; back in fashion; be in vogue}
\end{ExplainCard}

\begin{ExplainCard}{be attributed to}[phrase][C1]
  \EN{To be said or thought to be the result of a particular cause.}
  \SY{Ascribed to, credited to, due to.}
  \VI{Được quy cho là do; bởi.}
  \EX{The drop in cases is attributed to vaccination.}
  \EX{Many failures were attributed to poor planning.}
  \CO{be largely/widely attributed to; attribute success/decline to}
\end{ExplainCard}

\begin{ExplainCard}{a myriad of}[phrase][C1]
  \EN{An extremely large number of; countless.}
  \SY{A host of, innumerable, myriad.}
  \VI{Vô số, rất nhiều.}
  \EX{A myriad of apps compete for attention.}
  \EX{There are a myriad of factors to consider.}
  \CO{a myriad of options/causes/variables}
\end{ExplainCard}

\begin{ExplainCard}{social stratification}[phrase][C1]
  \EN{The hierarchical arrangement of individuals into classes or strata based on wealth, status, and power.}
  \SY{Social hierarchy, class structure.}
  \VI{Sự phân tầng xã hội.}
  \EX{Education can both reflect and reshape social stratification.}
  \EX{The study quantifies social stratification across regions.}
  \CO{patterns/levels of social stratification; reproduce/reinforce stratification}
\end{ExplainCard}

\begin{ExplainCard}{try (one’s) utmost}[idiom][B2]
  \EN{To do something as well as possible by making a great effort.}
  \SY{Do one’s best, go all out, spare no effort.}
  \VI{Cố gắng hết sức.}
  \EX{We’ll try our utmost to meet the deadline.}
  \EX{She tried her utmost to secure funding.}
  \CO{try/do your utmost to; to the utmost of one’s ability}
\end{ExplainCard}

\begin{ExplainCard}{driving force}[n][B2]
  \EN{A person or thing that strongly influences or causes something to happen.}
  \SY{Catalyst, engine, impetus, motive power.}
  \VI{Động lực/nhân tố thúc đẩy.}
  \EX{Innovation is the driving force behind growth.}
  \EX{She was the driving force of the campaign.}
  \CO{the/main driving force behind sth; act/serve as a driving force}
\end{ExplainCard}

\begin{ExplainCard}{splurge on}[v][C1]
  \EN{To spend a lot of money on something you do not strictly need.}
  \SY{Splash out on (BrE), indulge in, treat oneself to.}
  \VI{Vung tiền/chi đậm cho.}
  \EX{They splurged on a weekend getaway.}
  \EX{I rarely splurge on designer clothes.}
  \CO{splurge on gadgets/travel/a treat; an occasional/rare splurge (n)}
\end{ExplainCard}

\begin{ExplainCard}{indulgence}[n][C1]
  \EN{(1) Allowing yourself or someone to have what they want. (2) Something you do for pleasure, not necessity.}
  \SY{Self-indulgence, gratification; treat, luxury.}
  \VI{(1) Sự nuông chiều. (2) Thú vui/điều xa xỉ.}
  \EX{A spa day is my favorite indulgence.}
  \EX{Too much indulgence can spoil a child.}
  \CO{an occasional/small indulgence; self-indulgence; indulge a child/craving}
\end{ExplainCard}

\begin{ExplainCard}{acquisition}[n][B2]
  \EN{(1) The act of getting or gaining something (knowledge, skills). (2) A company or property bought by another.}
  \SY{(1) Attainment; (2) purchase, takeover.}
  \VI{(1) Sự đạt được/tiếp thu. (2) Thương vụ mua lại.}
  \EX{Language acquisition peaks in early childhood.}
  \EX{The firm announced a major acquisition in fintech.}
  \CO{knowledge/skill/data acquisition; merger and acquisition (M\&A); make/complete an acquisition}
\end{ExplainCard}

\begin{ExplainCard}{ever-increasing}[adj][B2]
  \EN{Continuing to grow in size, amount, or scope.}
  \SY{Constantly rising, mounting, growing.}
  \VI{Không ngừng tăng; ngày càng tăng.}
  \EX{Cities face ever-increasing housing costs.}
  \EX{An ever-increasing volume of data demands new tools.}
  \CO{ever-increasing demand/costs/pressure/complexity}
\end{ExplainCard}

\begin{ExplainCard}{impulsive purchases}[phrase][B2]
  \EN{Unplanned buying decisions made just before purchase.}
  \SY{Impulse buys, spur-of-the-moment purchases.}
  \VI{Mua sắm bốc đồng/không kế hoạch.}
  \EX{Bright displays can trigger impulsive purchases.}
  \EX{Budgeting apps help curb impulsive purchases.}
  \CO{make/curb/avoid impulsive purchases; impulse buying/behaviour}
\end{ExplainCard}

\begin{ExplainCard}{run into debt}[idiom][B2]
  \EN{To come to owe money; to accumulate debts.}
  \SY{Get into debt, fall into arrears, go into the red.}
  \VI{Rơi vào cảnh nợ nần.}
  \EX{Many students run into debt without a budget.}
  \EX{Households ran into debt after job losses.}
  \CO{run/get into debt; pay off/clear debts; deep/heavy debt}
\end{ExplainCard}

\begin{ExplainCard}{proliferation}[n][C1]
  \EN{A rapid and often excessive increase in number or amount.}
  \SY{Boom, surge, expansion, mushrooming.}
  \VI{Sự gia tăng nhanh chóng; tràn lan.}
  \EX{The proliferation of apps has changed media habits.}
  \EX{We must control the proliferation of invasive species.}
  \CO{proliferation of X; curb/control/face proliferation}
\end{ExplainCard}

\begin{ExplainCard}{gain access to}[phrase][B2]
  \EN{To succeed in entering, using, or obtaining something.}
  \SY{Access, obtain entry to, reach.}
  \VI{Tiếp cận/được quyền sử dụng.}
  \EX{Rural clinics struggle to gain access to supplies.}
  \EX{Students can gain access to journals via the library.}
  \CO{gain/secure access to data/services/markets; provide/expand access}
\end{ExplainCard}

\begin{ExplainCard}{newly-launched products}[phrase][B2]
  \EN{Products introduced to the market for the first time.}
  \SY{New releases, new launches.}
  \VI{Sản phẩm mới ra mắt/thị trường.}
  \EX{Reviews of newly-launched products appear weekly.}
  \EX{The firm staggered newly-launched products across quarters.}
  \CO{launch/unveil a product; a product launch/rollout; early adopters of new products}
\end{ExplainCard}

\begin{ExplainCard}{potential customers}[phrase][B2]
  \EN{People who are not yet customers but are likely to become ones.}
  \SY{Prospects, leads.}
  \VI{Khách hàng tiềm năng.}
  \EX{Campaigns target potential customers on social media.}
  \EX{Demos convert potential customers into buyers.}
  \CO{identify/reach/convert potential customers; customer acquisition}
\end{ExplainCard}

\begin{ExplainCard}{manifold}[adj][C1]
  \EN{Many and of various kinds; numerous and diverse.}
  \SY{Multiple, numerous, diverse, varied.}
  \VI{Rất đa dạng, muôn hình.}
  \EX{The project faces manifold challenges.}
  \EX{Climate change has manifold impacts on health.}
  \CO{manifold benefits/challenges/uses; in manifold ways}
\end{ExplainCard}

\begin{ExplainCard}{tremendous}[adj][B2]
  \EN{(1) Very great in amount, scale, or intensity. (2) (Infml) Excellent.}
  \SY{Enormous, immense, huge; terrific.}
  \VI{(1) Rất lớn; to lớn. (2) Tuyệt vời (khẩu ngữ).}
  \EX{The policy had a tremendous impact.}
  \EX{She’s done a tremendous job on the report.}
  \CO{tremendous impact/growth/pressure; a tremendous amount of}
\end{ExplainCard}

\begin{ExplainCard}{facilitate}[v][C1]
  \EN{To make an action or process possible or easier.}
  \SY{Enable, ease, expedite, streamline.}
  \VI{Tạo điều kiện; làm cho dễ hơn.}
  \EX{New tools facilitate remote collaboration.}
  \EX{Clear guidelines facilitate compliance.}
  \CO{facilitate learning/communication/access; a facilitator; facilitation of}
\end{ExplainCard}

\begin{ExplainCard}{time-consuming}[adj][B2]
  \EN{Taking a lot of time; requiring considerable time to do.}
  \SY{Laborious, lengthy, tedious.}
  \VI{Tốn nhiều thời gian.}
  \EX{Manual data entry is time-consuming.}
  \EX{Peer review can be time-consuming but essential.}
  \CO{a time-consuming process/task; prove/become time-consuming}
\end{ExplainCard}

\begin{ExplainCard}{brick-and-mortar shops}[phrase][B2]
  \EN{Physical stores located in buildings, as opposed to online outlets.}
  \SY{Physical retail stores, offline shops.}
  \VI{Cửa hàng truyền thống (có mặt bằng).}
  \EX{Many still prefer brick-and-mortar shops for groceries.}
  \EX{Brands blend online sales with brick-and-mortar stores.}
  \CO{visit/support brick-and-mortar shops; brick-and-mortar vs. online}
\end{ExplainCard}

\begin{ExplainCard}{in droves}[idiom][B2]
  \EN{In very large numbers.}
  \SY{En masse, by the thousands, in great numbers.}
  \VI{Đông đảo; với số lượng lớn.}
  \EX{Tourists arrived in droves after the festival opened.}
  \EX{Workers left in droves during the downturn.}
  \CO{come/arrive/leave in droves; customers/users/students in droves}
\end{ExplainCard}

\begin{ExplainCard}{take the plunge}[idiom][B2]
  \EN{To decide to do something risky or significant after hesitating.}
  \SY{Commit, go for it, make the leap.}
  \VI{Quyết liều/đưa ra quyết định lớn.}
  \EX{She finally took the plunge and started a business.}
  \EX{We took the plunge and moved abroad.}
  \CO{finally/ready to take the plunge; take the plunge into X}
\end{ExplainCard}

\begin{ExplainCard}{be all the go}[idiom][C1]
  \EN{To be very fashionable or popular. (\textit{cf.} \emph{all the rage}.)}
  \SY{All the rage, in vogue, trendy.}
  \VI{Rất thịnh hành, “hot”.}
  \EX{Minimalist sneakers are all the go this season.}
  \EX{At the time, micro-blogs were all the go.}
  \CO{be all the go with/among; become/remain all the go}
\end{ExplainCard}
\end{VocabExplain}


\begin{VocabHighlights}
\VH{to cross one’s mind}{(phrase) (of a thought) occur to one, especially transiently}{(cụm từ) (suy nghĩ) nảy ra trong đầu}
\VH{to be frank}{(phrase) introduce a statement which is your honest opinion}{(cụm từ) thực tế mà nói thì}
\VH{a night owl}{(idiom) a person who enjoys staying up late at night}{(thành ngữ) người thức khuya}
\VH{to turn in}{(phr. v) to go to sleep}{(cụm động từ) đi ngủ}
\VH{to make an attempt at v-ing}{(phrase) to make an effort to V}{(cụm từ) cố gắng làm gì}
\VH{to hit the gym}{(idiom) to head to the gym to work out}{(thành ngữ) đến tập ở phòng gym}
\VH{a mountain to climb}{(idiom) a very difficult task or challenge}{(thành ngữ) 1 việc rất khó khăn}
\VH{to follow a similar pattern}{(phrase) happen in the same way}{(cụm từ) diễn ra y hệt}
\VH{to be under obligations to V-inf}{(phrase) to be forced to V-inf}{(cụm từ) bị bắt buộc phải làm gì}
\VH{to be in the habit of}{(phrase) do it regularly or often}{(cụm từ) có thói quen làm gì}
\VH{to lie in}{(phr. v) remain in bed after the normal time for getting up}{(cụm động từ) ngủ nướng}
\VH{(for) a change of pace}{(phrase) a variation in routine or activity}{(cụm từ) sự đổi gió}
\VH{to chow down on}{(phr. v) to eat}{(cụm động từ) ăn}
\VH{to call it a day}{(idiom) to stop working for the day}{(thành ngữ) tạm nghỉ làm}
\VH{to indulge oneself in}{(v) to allow yourself to have or do something that you like, especially something that is considered bad for you}{(động từ) tự cho phép bản thân làm gì đó}
\VH{to grab a bite}{(idiom) to go somewhere to eat}{(thành ngữ) đi ăn}
\VH{to be flush}{(idiom) having a lot of money}{(thành ngữ) có nhiều tiền}
\VH{to burn the candle at both ends}{(idiom) go to bed late and get up early, especially to get work done}{(thành ngữ) làm việc ngày đêm}

\VH{of utmost importance}{(phrase) used to emphasize how important something is}{(cụm từ) vô cùng quan trọng}
\VH{promotional campaign}{(phrase) a program is aimed to boost sales}{(cụm từ) chiến dịch quảng cáo, tăng doanh thu}
\VH{behemoth}{(n) a very big and powerful company}{(danh từ) công ty lớn}
\VH{to slash prices}{(phrase) to reduce money}{(cụm từ) giảm giá}
\VH{to increase the volume of sales}{(phrase) to become larger in the number of items sold}{(cụm từ) tăng số lượng bán hàng}
\VH{on a tight budget}{(idiom) small amount of money for plan could not afford to overspend}{(thành ngữ) ngân sách eo hẹp}
\VH{to execute transactions}{(phrase) an occasion when someone buys or sells something}{(cụm từ) thực hiện giao dịch}
\VH{to wind down}{(phr. v) to relax after doing something}{(cụm động từ) thư giãn}
\VH{to be wound up}{(phr. v) be stressed}{(cụm động từ) bị căng thẳng}
\VH{to get a load off my mind}{(idiom) release your stress}{(thành ngữ) giảm căng thẳng}
\VH{erratic work schedules}{(phrase) a list of planned activities that is not regular, certain, or expected}{(cụm từ) lịch làm việc thất thường}
\VH{to keep up with the market variations}{(phrase) to continue to reach with the change of trade}{(cụm từ) theo kịp sự thay đổi của thị trường}
\VH{to play a pivotal role}{(phrase) to take part in central and important position}{(cụm từ) đóng vai trò quan trọng}
\VH{handy}{(adj) useful or convenient}{(tính từ) tiện lợi}

\VH{to diverge}{(v) to separate and go in different directions}{(động từ) khác nhau, chia tách}
\VH{for the most part}{(phrase) in most cases, usually}{(cụm từ) nhìn chung}
\VH{indicators}{(n) signs that shows you what something is like or how a situation is changing}{(danh từ) dấu hiệu}
\VH{socioeconomic}{(adj) relating to society and economics}{(tính từ) thuộc về kinh tế xã hội}
\VH{affluence}{(n) the state of having a lot of money and a good standard of living}{(danh từ) sự giàu có, sung túc}
\VH{to strive for}{(v) to try very hard to achieve something}{(động từ) nỗ lực để đạt được cái gì đó}
\VH{exception}{(n) a person or thing that is not included in a general statement}{(danh từ) ngoại lệ}
\VH{to be occupied with}{(adj) busy with}{(tính từ) bận rộn với cái gì}
\VH{to cover somebody's bills}{(phrase) to cover the costs or expenses}{(cụm từ) chi trả chi tiêu hằng ngày}
\VH{let alone}{(phrase) used after a statement to emphasize that because the first thing is not true or possible, the next thing cannot be true or possible either}{(cụm từ) chứ đừng nói đến}
\VH{to come into fashion}{(idiom) to become trendy}{(thành ngữ) trở thành mốt}
\VH{to be attributed to}{(p2) to say or believe that something is the result of a particular thing}{(phần từ 2) được quy cho; do cái gì}
\VH{a myriad of}{(n) extremely large in number}{(danh từ) rất nhiều}
\VH{social stratification}{(phrase) a kind of social differentiation whereby members of society are grouped into socioeconomic strata, based upon their occupation and income, wealth and social status, or derived power (social and political)}{(cụm từ) sự phân cấp, phân tầng xã hội}
\VH{to try somebody’s utmost}{(idiom) to do something as well as you can by making a great effort}{(thành ngữ) cố hết sức làm gì}
\VH{driving force}{(n) someone or something that has the power to make things happen}{(danh từ) động lực}
\VH{to splurge on}{(v) to spend a lot of money on something that you do not really need}{(động từ) vung tiền vào cái gì}
\VH{indulgence}{(n) the state or act of having or doing whatever you want; the state of allowing somebody to have or do whatever they want}{(danh từ) sự nuông chiều}
\VH{acquisition}{(n) the act of getting something, especially knowledge, a skill, etc}{(danh từ) học được, đạt được; thu được}
\VH{ever-increasing}{(phrase) to indicate something that continues to grow or prosper in size or scope}{(cụm từ) liên tục tăng}
\VH{impulsive purchases}{(phrase) an unplanned decision to buy a product or service, made just before a purchase}{(cụm từ) chi tiêu, mua sắm bừa bãi, không có kế hoạch}
\VH{to run into debt}{(idiom) to come to be in a position of owing money to someone or something}{(thành ngữ) rơi vào cảnh nợ nần}
\VH{proliferation}{(n) the sudden increase in the number or amount of something; a large number of a particular thing}{(danh từ) sự tăng nhanh; sinh sôi nảy nở}
\VH{to gain access to}{(phrase) to succeed in entering a place or in seeing someone or something}{(cụm từ) tiếp cận với cái gì}
\VH{newly-launched products}{(phrase) the debut of a product into the market}{(cụm từ) sản phẩm mới đưa ra thị trường}
\VH{potential customers}{(phrase) someone who’s not yet a customer but there are good odds that they might become one}{(cụm từ) khách hàng tiềm năng}
\VH{manifold}{(adj) many; of many different types}{(tính từ) rất đa dạng}
\VH{tremendous}{(adj) very great}{(tính từ) rất lớn; rất nhiều}
\VH{to facilitate}{(v) to make an action or a process possible or easier}{(động từ) tạo điều kiện}
\VH{time-consuming}{(adj) taking a lot of or too much time}{(tính từ) tốn thời gian}
\VH{brick-and-mortar shops}{(phrase) refers to a physical presence of an organization or business in a building or other structure}{(cụm từ) các cửa hàng truyền thống}
\VH{in droves}{(idiom) emphasizing that there is a very large number of}{(thành ngữ) có số lượng lớn}
\VH{to take the plunge}{(phrase) to make a decision to do something, especially after thinking about it for a long time}{(cụm từ) đưa ra quyết định đầu tư}
\VH{to be all the go}{(idiom) very fashionable or popular}{(thành ngữ) rất thời thượng, phổ biến}
\end{VocabHighlights}
