\begin{glossarymc}[Cambridge 5]
    ...
    \end{qa}
        ...
        \begin{VocabExplain}[Part 3]
            ...
            \EN{basically; in essence; used to emphasize the most important facts.}
            \SY{basically; fundamentally; in essence}
            \VI{\textit{về cơ bản}, \textit{cốt lõi mà nói}.}
            \EX{Essentially, the plan is to reduce costs without layoffs.}
            \EX{The two proposals are essentially the same.}
            \CO{essentially the same; essentially about; essentially, + clause}
            \end{ExplainCard}

            \begin{ExplainCard}{virtues}{n}
            \EN{good moral qualities or desirable traits in a person.}
            \SY{goodness; merits; moral qualities}
            \VI{\textit{đức hạnh}, \textit{phẩm chất tốt}.}
            \EX{Patience and honesty are important virtues.}
            \EX{She taught her kids the virtues of hard work.}
            \CO{cultivate virtues; civic virtues; cardinal virtues}
            \end{ExplainCard}

            \begin{ExplainCard}{probity}{n}
            \EN{complete honesty and integrity.}
            \SY{integrity; uprightness; honesty}
            \VI{\textit{chính trực}, \textit{liêm khiết}.}
            \EX{The judge is respected for his probity.}
            \EX{Public offices demand financial probity.}
            \CO{personal probity; reputation for probity}
            \end{ExplainCard}

            \begin{ExplainCard}{empathy}{n}
            \EN{the ability to understand and share another person’s feelings.}
            \SY{compassion; understanding; fellow feeling}
            \VI{\textit{sự thấu cảm}, đặt mình vào vị trí người khác.}
            \EX{Leaders need empathy to build trust.}
            \EX{Her empathy helped calm the upset customer.}
            \CO{show/feel empathy; empathy for/toward}
            \end{ExplainCard}

            \begin{ExplainCard}{decisive}{adj}
            \EN{(1) settling an issue; determining the result. (2) able to make decisions quickly and confidently.}
            \SY{(1) conclusive; determining \quad (2) resolute; determined}
            \VI{(1) \textit{mang tính quyết định}. (2) \textit{quyết đoán}.}
            \EX{(1) Timing was a decisive factor in their victory.}
            \EX{(2) She is decisive under pressure.}
            \CO{decisive factor; decisive victory; be decisive}
            \end{ExplainCard}

            \begin{ExplainCard}{transparent}{adj}
            \EN{(1) easy to understand; not hidden. (2) allowing light to pass through.}
            \SY{(1) clear; open \quad (2) see-through; translucent}
            \VI{(1) \textit{minh bạch, rõ ràng}. (2) \textit{trong suốt}.}
            \EX{(1) We want transparent communication in teams.}
            \EX{(2) The glass is almost transparent.}
            \CO{transparent process; financial transparency}
            \end{ExplainCard}

            \begin{ExplainCard}{tolerate / tolerating}{v}
            \EN{(1) to allow something unpleasant to continue without protest. (2) to be able to endure a difficult condition.}
            \SY{(1) accept; put up with \quad (2) withstand; endure}
            \VI{(1) \textit{khoan dung/tha thứ}. (2) \textit{chịu đựng}.}
            \EX{(1) Good friends tolerate each other’s small mistakes.}
            \EX{(2) Some people cannot tolerate loud noise.}
            \CO{tolerate behavior; tolerate differences; pain tolerance}
            \end{ExplainCard}

            \begin{ExplainCard}{get to the bottom of}{idiom}
            \EN{to discover the real cause or truth of something.}
            \SY{find out; uncover; get the truth}
            \VI{\textit{tìm ra gốc rễ} vấn đề.}
            \EX{Let’s get to the bottom of the misunderstanding.}
            \EX{It took weeks to get to the bottom of the bug.}
            \CO{get to the bottom of \{a problem/mystery\}}
            \end{ExplainCard}

            \begin{ExplainCard}{folly}{n}
            \EN{lack of good sense; foolish action or idea.}
            \SY{foolishness; imprudence; absurdity}
            \VI{\textit{sự dại dột}, \textit{hành động ngu ngốc}.}
            \EX{He admitted the folly of ignoring advice.}
            \EX{History teaches us the folly of war.}
            \CO{the folly of \{youth/haste\}; sheer folly}
            \end{ExplainCard}

            \begin{ExplainCard}{stand by (someone)}{phr.\ v}
            \EN{to support or remain loyal to someone.}
            \SY{back; support; stick with}
            \VI{\textit{đứng về phía/ở bên} ai.}
            \EX{True friends stand by you in tough times.}
            \EX{She stood by her colleague during the inquiry.}
            \CO{stand by a friend/decision; always stand by}
            \end{ExplainCard}

            \begin{ExplainCard}{in deep water}{idiom}
            \EN{in serious trouble or a difficult situation.}
            \SY{in hot water; in a bind; in trouble}
            \VI{\textit{gặp rắc rối lớn}.}
            \EX{He was in deep water after missing the deadline.}
            \EX{She helped me when I was in deep water financially.}
            \CO{be/land in deep water; get out of deep water}
            \end{ExplainCard}

            \begin{ExplainCard}{long-lasting}{adj}
            \EN{continuing for a long time; durable.}
            \SY{enduring; durable; sustained}
            \VI{\textit{lâu bền}, kéo dài.}
            \EX{Long-lasting friendships take time to build.}
            \EX{They reached a long-lasting agreement.}
            \CO{long-lasting effect/relationship/impact}
            \end{ExplainCard}

            \begin{ExplainCard}{tricky}{adj}
            \EN{(1) difficult to deal with. (2) requiring care because of possible deception.}
            \SY{(1) tough; challenging \quad (2) delicate; knotty}
            \VI{(1) \textit{khó nhằn}. (2) \textit{rắc rối/dễ sai}.}
            \EX{Choosing between offers is tricky.}
            \EX{It’s a tricky question with no single answer.}
            \CO{tricky situation/question/balance}
            \end{ExplainCard}

            \begin{ExplainCard}{make up one’s mind}{phrase}
            \EN{to decide after considering options.}
            \SY{reach a decision; settle on; determine}
            \VI{\textit{quyết định}.}
            \EX{I can’t make up my mind about the trip.}
            \EX{She finally made up her mind to apply.}
            \CO{make up your mind to + V; can’t make up my mind}
            \end{ExplainCard}

            \begin{ExplainCard}{dilemma}{n}
            \EN{a situation requiring a choice between two (or more) difficult options.}
            \SY{predicament; quandary; tight spot}
            \VI{\textit{tình thế tiến thoái lưỡng nan}.}
            \EX{He faced a dilemma: career or family.}
            \EX{The committee is in a budget dilemma.}
            \CO{face a dilemma; moral dilemma; present a dilemma}
            \end{ExplainCard}

            \begin{ExplainCard}{it is not to say (that)}{phrase}
            \EN{a hedge meaning “this does not mean that …”; used to soften contrast.}
            \SY{not to suggest; this doesn’t imply}
            \VI{\textit{không có nghĩa là}.}
            \EX{I prefer family time; it is not to say that I devalue friendship.}
            \EX{Funds are limited, which is not to say the project is dead.}
            \CO{not to say + clause; which is not to say}
            \end{ExplainCard}

            \begin{ExplainCard}{underestimate}{v}
            \EN{(1) to think that something is smaller/less important than it is. (2) to judge someone’s ability too low.}
            \SY{undervalue; underrate; play down}
            \VI{(1) \textit{đánh giá thấp}. (2) \textit{xem thường năng lực}.}
            \EX{Never underestimate the power of habit.}
            \EX{They underestimated her leadership skills.}
            \CO{underestimate the importance/risks/ability}
            \end{ExplainCard}

            \begin{ExplainCard}{A friend in need is a friend indeed}{proverb}
            \EN{a true friend proves their friendship by helping in hard times.}
            \SY{true friends appear in hardship}
            \VI{\textit{Hoạn nạn mới biết bạn hiền}.}
            \EX{He showed up at midnight—\textit{a friend in need is a friend indeed}.}
            \EX{When I lost my job, I learned who my real friends were.}
            \CO{proverb; used to praise loyal friends}
            \end{ExplainCard}

            \begin{ExplainCard}{dishonesty}{n}
            \EN{lack of honesty; behavior intended to deceive.}
            \SY{deceit; fraud; duplicity}
            \VI{\textit{sự không trung thực}, dối trá.}
            \EX{Dishonesty can destroy trust quickly.}
            \EX{The firm fired him for academic dishonesty.}
            \CO{academic/professional dishonesty; blatant dishonesty}
            \end{ExplainCard}

            \begin{ExplainCard}{ruin}{v}
            \EN{to damage something so badly that it is no longer good or useful.}
            \SY{spoil; wreck; destroy}
            \VI{\textit{phá hỏng}, \textit{huỷ hoại}.}
            \EX{Gossip can ruin a friendship.}
            \EX{Heavy rain ruined our picnic plans.}
            \CO{ruin a relationship/chance/reputation}
            \end{ExplainCard}

            \begin{ExplainCard}{fragile}{adj}
            \EN{(1) easily broken or damaged. (2) easily harmed emotionally or socially.}
            \SY{delicate; brittle; vulnerable}
            \VI{(1) \textit{dễ vỡ}. (2) \textit{mong manh/dễ tổn thương}.}
            \EX{(1) Handle the fragile glass with care.}
            \EX{(2) New relationships can be fragile.}
            \CO{fragile peace/health/relationship}
            \end{ExplainCard}

            \begin{ExplainCard}{intimate}{adj}
            \EN{(1) very close and personal. (2) private and warm.}
            \SY{close; personal; cozy}
            \VI{(1) \textit{thân thiết}. (2) \textit{riêng tư/ấm cúng}.}
            \EX{They share an intimate friendship built on trust.}
            \EX{The restaurant has an intimate atmosphere.}
            \CO{intimate friend; intimate knowledge; intimate setting}
            \end{ExplainCard}

            \begin{ExplainCard}{stimulating}{adj}
            \EN{(1) exciting interest or enthusiasm. (2) encouraging activity or development.}
            \SY{inspiring; engaging; energizing}
            \VI{(1) \textit{kích thích, thú vị}. (2) \textit{thúc đẩy/phát triển}.}
            \EX{We had a stimulating discussion about ethics.}
            \EX{A stimulating environment helps children learn.}
            \CO{stimulating conversation; intellectually stimulating}
            \end{ExplainCard}

            \begin{ExplainCard}{mutual trust}{phrase}
            \EN{trust that both sides have for each other.}
            \SY{reciprocal trust; shared confidence}
            \VI{\textit{niềm tin lẫn nhau}.}
            \EX{Mutual trust is the basis of any partnership.}
            \EX{Teams with mutual trust perform better.}
            \CO{build mutual trust; mutual trust and respect}
            \end{ExplainCard}

            \begin{ExplainCard}{On top of that}{phrase}
            \EN{in addition; moreover (often to add a further reason).}
            \SY{furthermore; besides; additionally}
            \VI{\textit{hơn nữa}, \textit{chưa kể}.}
            \EX{The rent is high; on top of that, utilities are expensive.}
            \EX{She’s talented and, on top of that, very humble.}
            \CO{on top of that + clause}
            \end{ExplainCard}

            \begin{ExplainCard}{pointless}{adj}
            \EN{having no useful purpose or result.}
            \SY{futile; useless; aimless}
            \VI{\textit{vô nghĩa}, \textit{không đem lại kết quả}.}
            \EX{It’s pointless to argue over trivial details.}
            \EX{The meeting felt pointless without data.}
            \CO{pointless argument; seem/be pointless}
            \end{ExplainCard}

            \begin{ExplainCard}{harmonious}{adj}
            \EN{(1) friendly and cooperative. (2) forming a pleasing or consistent whole.}
            \SY{amicable; congenial; well-balanced}
            \VI{(1) \textit{hoà thuận}. (2) \textit{hài hoà}.}
            \EX{(1) They maintain a harmonious workplace.}
            \EX{(2) The design uses harmonious colors.}
            \CO{harmonious relationship; harmonious blend}
            \end{ExplainCard}

            \begin{ExplainCard}{conducive}{adj}
            \EN{making a certain situation or outcome likely; tending to promote. \textit{(Often misspelled “conductive” in this sense.)}}
            \SY{favorable to; helpful; promotive}
            \VI{\textit{có lợi/thuận lợi cho}.}
            \EX{Quiet rooms are conducive to deep work.}
            \EX{A supportive boss is conducive to morale.}
            \CO{conducive to learning/health/productivity}
            \end{ExplainCard}

            \begin{ExplainCard}{climb up the ladder}{idiom}
            \EN{to advance to higher levels in a career or social hierarchy.}
            \SY{advance; move up; get promoted}
            \VI{\textit{thăng tiến}, leo nấc thang sự nghiệp.}
            \EX{He’s eager to climb up the ladder in marketing.}
            \EX{Networking can help you climb the ladder faster.}
            \CO{climb the career ladder; move up the ladder}
            \end{ExplainCard}

            \begin{ExplainCard}{radically}{adv}
            \EN{in a very great or fundamental way; extremely.}
            \SY{drastically; profoundly; fundamentally}
            \VI{\textit{mạnh mẽ}, \textit{triệt để}.}
            \EX{Work patterns changed radically after the pandemic.}
            \EX{Their views differ radically on this issue.}
            \CO{change/shift radically; radically different}
            \end{ExplainCard}

            \begin{ExplainCard}{traumas}{n}
            \EN{(1) severe emotional shocks. (2) physical injuries (medical).}
            \SY{(1) psychological wounds \quad (2) injuries}
            \VI{(1) \textit{tổn thương tâm lý}. (2) \textit{chấn thương} (y khoa).}
            \EX{(1) Friends can help us heal from past traumas.}
            \EX{(2) The ER treats multiple traumas after accidents.}
            \CO{childhood trauma; trauma recovery; trauma care}
            \end{ExplainCard}

            \begin{ExplainCard}{self-assessment}{n}
            \EN{evaluation of one’s own performance, abilities, or behavior.}
            \SY{self-evaluation; self-review; introspection}
            \VI{\textit{tự đánh giá} bản thân.}
            \EX{Regular self-assessment helps you grow.}
            \EX{Managers request a self-assessment before reviews.}
            \CO{do/complete a self-assessment; honest self-assessment}
            \end{ExplainCard}

            \begin{ExplainCard}{Achilles’ heel}{n}
            \EN{a weak or vulnerable point in someone’s character or system.}
            \SY{weak spot; vulnerability; soft underbelly}
            \VI{\textit{gót chân Achilles}, điểm yếu chí tử.}
            \EX{Procrastination is his Achilles’ heel.}
            \EX{Security remains the system’s Achilles’ heel.}
            \CO{be/has an Achilles’ heel; expose an Achilles’ heel}
            \end{ExplainCard}

            \begin{ExplainCard}{lone wolf / lone wolves}{n}
            \EN{a person who prefers to act or be alone rather than with a group.}
            \SY{solitary person; independent operator}
            \VI{\textit{người thích đơn độc}, làm việc một mình.}
            \EX{He’s a lone wolf who rarely joins team outings.}
            \EX{Some artists work as lone wolves to protect their vision.}
            \CO{be a lone wolf; operate as a lone wolf}
            \end{ExplainCard}

            \begin{ExplainCard}{hang out}{phr.\ v}
            \EN{to spend time relaxing or socializing.}
            \SY{chill; socialize; spend time}
            \VI{\textit{đi chơi/tụ tập}, thư giãn cùng nhau.}
            \EX{We usually hang out at the café after class.}
            \EX{They’re hanging out at her place tonight.}
            \CO{hang out with friends; hang out at \{a park\}}
            \end{ExplainCard}
        \end{VocabExplain}
    ...
    \begin{VocabHighlights}
        ...
        \VH{composition}{(n) a piece of music or art, or a poem}{(danh từ) sự sáng tác}
        \VH{to give somebody a big thrill}{(phrase) to thrill somebody}{(cụm từ) khiến ai rùng mình}
        \VH{preference}{(n) a greater interest in or desire for somebody/something than somebody/something else}{(danh từ) sự ưa thích hơn}
        \VH{to clear one’s mind/head}{(idiom) to stop worrying or thinking about something}{(thành ngữ) ngừng lo lắng, nhẹ đầu}
        \VH{to gravitate (towards)}{(v) to move towards somebody/something that you are attracted to}{(động từ) hướng về, đổ về}
        \VH{in the company of}{(phrase) together with}{(cụm từ) cùng với}
        \VH{a penchant (for)}{(n) a special liking for something}{(danh từ) xu hướng thích gì}
        \VH{from time to time}{(idiom) occasionally}{(thành ngữ) thỉnh thoảng}
        \VH{to outnumber}{(v) to be greater in number than somebody/something}{(động từ) có nhiều hơn}
        \VH{gambling}{(n) the activity of playing games of chance for money and of betting on horses, etc}{(danh từ) trò cờ bạc}
        \VH{lady luck}{(idiom) The personification of fortune}{(thành ngữ) thần may mắn}
        \VH{in all likelihood}{(idiom) very probably}{(thành ngữ) rất có thể}
        \VH{to go bankrupt}{(phrase) to be unable to pay one’s debts}{(cụm từ) phá sản}
        \VH{to be stressed out}{(phr.v) to be under stress}{(cụm động từ) bị căng thẳng}
        \VH{to let it all hang out}{(idiom) be very relaxed or uninhibited}{(thành ngữ) thư giãn}
        \VH{to get on like a house on fire}{(idiom) like each other very much and become friend and very quickly}{(thành ngữ) nhanh chóng thành bạn thân, hợp cạ}
        \VH{to tighten the bond}{(phrase) have a closer relationship by doing something together}{(cụm từ) thắt chặt tình cảm}
        \VH{to catch upon gossip}{(phrase) to chit chat}{(cụm từ) tán gẫu}
        \VH{to give somebody a listening ear}{(idiom) to listen to you when you need to confide in}{(thành ngữ) lắng nghe khi bạn cần tâm sự}
        \VH{to be always there for somebody}{(phrase) to be always ready to help someone when they need help}{(cụm từ) luôn bên cạnh giúp đỡ tôi}
        \VH{to stick up for somebody}{(phr.v) to defend someone who is criticized, especially when no one else will defend them}{(cụm động từ) bảo vệ ai}
        \VH{through thick and thin}{(idiom) through good times and bad times}{(thành ngữ) qua thăng trầm}
        \VH{to laugh my head off}{(idiom) to laugh a lot, loudly}{(thành ngữ) cười nắc nẻ}
        \VH{essentially}{(adv) when you think about the true, important or basic nature of somebody/something}{(trạng ngữ) về cơ bản}
        \VH{virtue}{(n) a behaviour or an attitude that show high moral standards}{(danh từ) một đức tính tốt}
        \VH{probity}{(n) the quality of being completely honest}{(danh từ) sự trung thực; đáng tin cậy}
        \VH{empathy}{(n) the ability to understand another person’s feelings, experience, etc}{(danh từ) sự đồng cảm}
        \VH{decisive}{(adj) very important for the final result of a particular situation}{(tính từ) mang tính quyết định}
        \VH{transparent}{(adj) allowing you to see the truth easily}{(tính từ) cởi mở, chân thành}
        \VH{tolerating}{(adj) can be acceptable}{(tính từ) có thể tha thứ}
        \VH{folly}{(n) a very stupid thing to do, especially one that is likely to have serious results}{(danh từ) điều ngu ngốc}
        \VH{to stand by somebody}{(phr.v) to stay loyal to someone and support them, especially in a difficult situation}{(cụm động từ) luôn bên ai}
        \VH{to be in deep water(s)}{(idiom) to be in trouble}{(thành ngữ) gặp rắc rối}
        \VH{long-lasting}{(adj) that can or does last for a long time}{(tính từ) bền vững; lâu dài}
        \VH{tricky}{(adj) difficult to do or deal with}{(tính từ) khó khăn; khó làm}
        \VH{to make up one’s mind}{(phrase) to decide}{(cụm từ) quyết định}
        \VH{a dilemma}{(n) a situation which makes problems, often one in which you have to make a very difficult choice between things of equal importance}{(danh từ) tình thế tiến thoái lưỡng nan}
        \VH{it is not to say that}{(idiom) this does not mean}{(thành ngữ) điều đó không phải là}
        \VH{to underestimate}{(v) to not realize how good, strong, determined, etc. somebody really is}{(động từ) đánh giá thấp}
        \VH{a friend in need is a friend indeed}{(phrase) a person who helps at a difficult time is a truly reliable person}{(cụm từ) người bạn (cứu mang mình) lúc mình gặp hoạn nạn là người bạn đích thực}
        \VH{dishonesty}{(n) the quality of being dishonest}{(danh từ) không thành thật, gian thật}
        \VH{to ruin}{(v) to damage something so badly that it loses all its value, pleasure, etc.; to spoil something}{(động từ) hủy hoại}
        \VH{fragile}{(adj) easily broken or damaged}{(tính từ) mỏng manh}
        \VH{intimate}{(adj) having a close and friendly relationship}{(tính từ) thân thiết}
        \VH{stimulating}{(adj) full of interesting or exciting ideas; making people feel enthusiastic}{(tính từ) gây hứng thú}
        \VH{mutual trust}{(phrase) the belief shared by two or more people}{(cụm từ) sự tin tưởng lẫn nhau}
        \VH{on top of that}{(phrase) more importantly}{(cụm từ) quan trọng hơn là}
        \VH{pointless}{(adj) having no purpose; not worth doing}{(tính từ) vô nghĩa}
        \VH{harmonious}{(adj) friendly, peaceful and without any disagreement}{(tính từ) hòa hợp}
        \VH{conductive}{(adj) making it easy, possible or likely for something to happen}{(tính từ) tạo điều kiện cho cái gì xảy ra}
        \VH{to climb the ladder}{(idiom) to become increasingly powerful or successful}{(thành ngữ) trở nên ngày càng thành công}
        \VH{radically}{(adv) in a way that concerns the most basic and important parts of something; in a thorough and complete way}{(trạng ngữ) hoàn toàn; triệt để}
        \VH{traumas}{(n) an unpleasant experience that makes you feel upset and/or anxious}{(danh từ) sự buồn chán; khủng hoảng tinh thần}
        \VH{self-assessment}{(n) the process of judging your own progress, achievements, etc}{(danh từ) tự đánh giá}
        \VH{Achilles heels}{(idiom) weak points}{(thành ngữ) điểm yếu}
        \VH{a lone wolf}{(idiom) a very independent or solitary person}{(thành ngữ) người không phụ thuộc ai, luôn 1 mình}
        \VH{to hang out with somebody}{(phrase) to go outside with somebody}{(cụm từ) dành thời gian đi chơi cùng ai}
    \end{VocabHighlights}
    \end{test}
    ...
    \end{qa}
        ...
        \begin{VocabExplain}[Part 1]
            ...
            \EN{to show or make clear one’s rank or position in society, often through behavior or possessions.}
            \SY{signal status; flaunt rank; proclaim standing}
            \VI{\textit{khẳng định địa vị xã hội}, thường bằng cách ăn mặc hay tiêu dùng.}
            \EX{Some people assert their social status through designer labels.}
            \EX{He never tries to assert his social status at work.}
            \CO{assert social status; assert dominance; assert identity}
            \end{ExplainCard}

            \begin{ExplainCard}{exorbitant}{adj}
            \EN{(of a price/fee) unreasonably high; far beyond what is fair or affordable.}
            \SY{outrageous; extortionate; steep}
            \VI{\textit{cắt cổ}, quá đắt.}
            \EX{Luxury handbags often come with exorbitant price tags.}
            \EX{The rent in that district is exorbitant for students.}
            \CO{exorbitant price/fee/charges}
            \end{ExplainCard}

            \begin{ExplainCard}{beyond (my/one’s) means}{phrase}
            \EN{costing more than someone can realistically afford.}
            \SY{unaffordable; out of reach; too pricey}
            \VI{\textit{vượt quá khả năng chi trả}.}
            \EX{Custom-made suits are beyond my means right now.}
            \EX{He avoids dining at places that are beyond his means.}
            \CO{live beyond one’s means; something is beyond one’s means}
            \end{ExplainCard}

            \begin{ExplainCard}{attach great importance to}{phrase}
            \EN{to consider something very significant or valuable.}
            \SY{value highly; place great emphasis on; prize}
            \VI{\textit{coi trọng}, đặt nặng tầm quan trọng.}
            \EX{I don’t attach great importance to brand names.}
            \EX{Our school attaches great importance to creativity.}
            \CO{attach importance/weight/significance to}
            \end{ExplainCard}

            \begin{ExplainCard}{dressed to kill}{idiom}
            \EN{wearing very fashionable or striking clothes intended to impress.}
            \SY{dressed to the nines; sharply dressed; decked out}
            \VI{\textit{ăn mặc cực kỳ nổi bật}, gây ấn tượng mạnh.}
            \EX{She arrived dressed to kill in a velvet gown.}
            \EX{I rarely get dressed to kill—comfort comes first.}
            \CO{be/turn up dressed to kill}
            \end{ExplainCard}

            \begin{ExplainCard}{in favor of}{phrase}
            \EN{preferring or supporting one option over another.}
            \SY{prefer; be partial to; be inclined toward}
            \VI{\textit{thiên về, ủng hộ}.}
            \EX{I’m in favor of simple, functional outfits.}
            \EX{They voted in favor of a casual dress code.}
            \CO{be in favor of; argue in favor of}
            \end{ExplainCard}

            \begin{ExplainCard}{come cheap}{phrase}
            \EN{to be available at a low price; not cost much.}
            \SY{be inexpensive; be affordable; be low-priced}
            \VI{\textit{rẻ tiền}, giá mềm.}
            \EX{These basics come cheap at factory outlets.}
            \EX{Quality tailoring doesn’t come cheap.}
            \CO{nothing comes cheap; good things don’t come cheap}
            \end{ExplainCard}

            \begin{ExplainCard}{be a slave to fashion}{idiom}
            \EN{to feel compelled to follow every new fashion trend.}
            \SY{fashion victim; trend-chaser}
            \VI{\textit{nô lệ thời trang}, chạy theo mốt.}
            \EX{I refuse to be a slave to fashion.}
            \EX{Being a slave to fashion can drain your budget.}
            \CO{become a slave to fashion; fashion slave}
            \end{ExplainCard}

            \begin{ExplainCard}{killer fashion taste}{phrase}
            \EN{very impressive or enviable sense of style. \textit{(Also: \textbf{killer fashion sense})}}
            \SY{impeccable style; great taste; sharp look}
            \VI{\textit{gu thời trang đỉnh}, rất sành điệu.}
            \EX{She’s known for her killer fashion taste on campus.}
            \EX{That stylist has a killer fashion sense for colors.}
            \CO{killer look/outfit; killer taste/sense}
            \end{ExplainCard}

            \begin{ExplainCard}{averse to}{adj}
            \EN{strongly disliking or opposed to something.}
            \SY{disinclined; opposed; allergic to}
            \VI{\textit{dị ứng/không ưa}, phản đối.}
            \EX{I’m averse to flashy logos.}
            \EX{He isn’t averse to second-hand clothes.}
            \CO{be averse to + V\textsubscript{ing}/noun}
            \end{ExplainCard}

            \begin{ExplainCard}{revealing}{adj}
            \EN{(of clothing) showing parts of the body that are usually covered.}
            \SY{skimpy; low-cut; provocative}
            \VI{\textit{hở hang}.}
            \EX{She avoids dresses that are too revealing.}
            \EX{The dress code bans revealing tops.}
            \CO{revealing dress/outfit/neckline}
            \end{ExplainCard}

            \begin{ExplainCard}{lithe grace}{phrase}
            \EN{slender, flexible elegance in movement or appearance.}
            \SY{supple elegance; delicate poise}
            \VI{\textit{vẻ mềm mại uyển chuyển}.}
            \EX{The dancer moved with lithe grace.}
            \EX{She prefers styles that highlight lithe grace, not curves.}
            \CO{move with lithe grace; lithe and graceful}
            \end{ExplainCard}

            \begin{ExplainCard}{show off}{phr.\ v}
            \EN{to display something proudly or conspicuously, often to impress.}
            \SY{flaunt; parade; boast}
            \VI{\textit{khoe khoang}, phô bày.}
            \EX{He loves to show off his new sneakers.}
            \EX{You don’t need to show off to look confident.}
            \CO{show off wealth/style; showy}
            \end{ExplainCard}

            \begin{ExplainCard}{If my memory serves me correctly}{phrase}
            \EN{used to introduce information you believe you remember accurately.}
            \SY{as far as I recall; if I remember right}
            \VI{\textit{nếu tôi nhớ không nhầm}.}
                \EX{If my memory serves me correctly, flares were huge in 2010.}
                \EX{If my memory serves me correctly, that brand launched last year.}
            \CO{If my memory serves (me) (right/correctly)}
            \end{ExplainCard}

            \begin{ExplainCard}{trend towards}{n\slash phrase}
            \EN{a general movement in preference or behavior in the direction of something.}
            \SY{shift toward; drift to; movement toward}
            \VI{\textit{xu hướng nghiêng về}.}
            \EX{There’s a trend towards athleisure at offices.}
            \EX{Analysts note a trend toward sustainable fabrics.}
            \CO{trend towards/to + noun/V\textsubscript{ing}}
            \end{ExplainCard}

            \begin{ExplainCard}{bell-bottoms}{n}
            \EN{trousers widening from the knee downward to form a bell shape.}
            \SY{flared pants; flares}
            \VI{\textit{quần ống loe}.}
            \EX{Bell-bottoms dominated the 70s.}
            \EX{Fashion cycles bring bell-bottoms back every decade.}
            \CO{wear bell-bottoms; flared/bell-bottom jeans}
            \end{ExplainCard}

            \begin{ExplainCard}{opt for}{v}
            \EN{to choose one thing instead of another.}
            \SY{choose; go for; pick}
            \VI{\textit{lựa chọn}.}
            \EX{Many teens opt for joggers over jeans.}
            \EX{I opted for neutral colors this season.}
            \CO{opt for/against; opt to + V}
            \end{ExplainCard}

            \begin{ExplainCard}{on trend}{adj\slash phrase}
            \EN{fashionable; currently popular.}
            \SY{trendy; in vogue; fashionable}
            \VI{\textit{đúng mốt}, hợp xu hướng.}
            \EX{Chunky sneakers are still on trend.}
            \EX{Are cargo pants on trend this year?}
            \CO{stay on trend; be on-trend looks}
            \end{ExplainCard}

            \begin{ExplainCard}{inclined to}{adj\slash phrase}
            \EN{having a tendency or preference to do something.}
            \SY{prone to; apt to; liable to}
            \VI{\textit{có xu hướng}, thiên về.}
            \EX{I’m inclined to pick breathable fabrics.}
            \EX{Shoppers are inclined to buy basics in a recession.}
            \CO{be inclined to + V; feel inclined to}
            \end{ExplainCard}

            \begin{ExplainCard}{speak volumes}{idiom}
            \EN{to convey a lot of information without words, or with very little said.}
            \SY{say a lot; be telling; reveal much}
            \VI{\textit{nói lên rất nhiều}, tự bản thân đã cho thấy.}
            \EX{A well-worn jacket can speak volumes about values.}
            \EX{His quiet confidence speaks volumes.}
            \CO{speaks volumes about/for}
            \end{ExplainCard}

            \begin{ExplainCard}{project (one’s) wealth}{v}
            \EN{to deliberately present an image of being wealthy.}
            \SY{signal affluence; flaunt wealth; exude luxury}
            \VI{\textit{phô bày/sự giàu có}.}
            \EX{Logo-heavy outfits project wealth more than taste.}
            \EX{She avoids projecting wealth at client meetings.}
            \CO{project confidence/authority/wealth}
            \end{ExplainCard}

            \begin{ExplainCard}{mediocre}{adj}
            \EN{of only average quality; not very good.}
            \SY{so-so; middling; second-rate}
            \VI{\textit{thường thường bậc trung}, tầm thường.}
            \EX{High price doesn’t excuse mediocre stitching.}
            \EX{The design is trendy but the fabric feels mediocre.}
            \CO{mediocre quality/performance}
            \end{ExplainCard}

            \begin{ExplainCard}{poverty-stricken}{adj}
            \EN{extremely poor; suffering from great poverty.}
            \SY{destitute; impoverished; needy}
            \VI{\textit{cực kỳ nghèo khó}.}
            \EX{Poverty-stricken communities need affordable clothing.}
            \EX{He runs a drive to donate clothes to the poverty-stricken.}
            \CO{poverty-stricken areas/families}
            \end{ExplainCard}

            \begin{ExplainCard}{from scratch}{idiom}
            \EN{from the very beginning, without using anything that already exists.}
            \SY{from the ground up; anew; afresh}
            \VI{\textit{từ con số không}.}
            \EX{She built her capsule wardrobe from scratch.}
            \EX{The brand started from scratch with recycled fibers.}
            \CO{start/build/create from scratch}
            \end{ExplainCard}

            \begin{ExplainCard}{the bulk of}{phrase}
            \EN{the majority or greater part of something.}
            \SY{most of; the majority of; the lion’s share of}
            \VI{\textit{phần lớn}, đa số.}
            \EX{The bulk of his wardrobe is plain tees.}
            \EX{The bulk of costs comes from marketing.}
            \CO{the bulk of + noun; bulk buying}
            \end{ExplainCard}

            \begin{ExplainCard}{relatively affordable}{phrase}
            \EN{in comparison with alternatives, not too expensive.}
            \SY{reasonably priced; budget-friendly; accessible}
            \VI{\textit{tương đối phải chăng}.}
            \EX{Their basics are relatively affordable for students.}
            \EX{Relatively affordable pieces can last if you care for them.}
            \CO{relatively affordable option/brand}
            \end{ExplainCard}

            \begin{ExplainCard}{fancy clothes}{n}
            \EN{clothes that are elaborate, expensive, or meant to impress.}
            \SY{flashy outfits; dressy attire; high-end fashion}
            \VI{\textit{đồ cầu kỳ/đắt tiền}.}
            \EX{He avoids fancy clothes and sticks to neutrals.}
            \EX{Fancy clothes don’t guarantee good taste.}
            \CO{wear fancy clothes; fancy outfit/party}
            \end{ExplainCard}

            \begin{ExplainCard}{off-the-peg}{adj}
            \EN{(BrE) ready-made; not custom-tailored. \textit{(AmE: \textbf{off-the-rack})}}
            \SY{ready-to-wear; RTW; factory-made}
            \VI{\textit{may sẵn}, đồ đại trà.}
            \EX{Off-the-peg suits are cheaper than bespoke ones.}
            \EX{He prefers off-the-peg jeans for daily wear.}
            \CO{off-the-peg/out-the-rack clothing/sizes}
            \end{ExplainCard}
        \end{VocabExplain}
    ...
    \end{qa}
        ...
        \begin{VocabExplain}[Part 2]
            ...
            \EN{to experience or live through something (often a process of change, difficulty, or development).}
            \SY{go through; experience; be subject to}
            \VI{\textit{trải qua}, chịu (quá trình/thay đổi/khó khăn).}
            \EX{The city is undergoing rapid modernization.}
            \EX{She underwent surgery and recovered quickly.}
            \CO{undergo changes/reforms/tests; be undergoing}
            \end{ExplainCard}

            \begin{ExplainCard}{predominantly}{adv}
            \EN{mainly; for the most part; in greater degree than anything else.}
            \SY{mainly; chiefly; largely}
            \VI{\textit{chủ yếu}, phần lớn.}
            \EX{The area is predominantly agricultural.}
            \EX{Attendance was predominantly families with children.}
            \CO{predominantly + adj/noun; predominantly rural/urban}
            \end{ExplainCard}

            \begin{ExplainCard}{plentiful}{adj}
            \EN{existing in large amounts; more than enough.}
            \SY{abundant; ample; bountiful}
            \VI{\textit{dồi dào}, nhiều.}
            \EX{Fresh fruit is plentiful in summer.}
            \EX{Job opportunities are not as plentiful as they used to be.}
            \CO{plentiful supply/resources; be plentiful}
            \end{ExplainCard}

            \begin{ExplainCard}{date back to}{phrase}
            \EN{to have existed since a particular time in the past; to originate from.}
            \SY{go back to; trace back to; originate in}
            \VI{\textit{có từ}, \textit{bắt nguồn từ} (thời điểm nào đó).}
            \EX{The ritual dates back to the 10\textsuperscript{th} century.}
            \EX{These houses date back to the colonial era.}
            \CO{date back to + year/period; tradition dating back centuries}
            \end{ExplainCard}

            \begin{ExplainCard}{family reunion}{n}
            \EN{a gathering of family members, especially those who live far apart.}
            \SY{family gathering; get-together; homecoming}
            \VI{\textit{đoàn tụ gia đình}.}
            \EX{Tet is the biggest family reunion of the year.}
            \EX{They planned a beachside family reunion for July.}
            \CO{have/host a family reunion; annual reunion}
            \end{ExplainCard}

            \begin{ExplainCard}{give (someone) a hand}{idiom}
            \EN{to help or assist someone with a task.}
            \SY{lend a hand; help out; assist}
            \VI{\textit{giúp một tay}.}
            \EX{I’ll give you a hand with the decorations.}
            \EX{Neighbors gave the elderly couple a hand after the storm.}
            \CO{give/lend (sb) a hand with + noun}
            \end{ExplainCard}

            \begin{ExplainCard}{hold the notion (that)}{phrase}
            \EN{to believe or be of the opinion that something is true.}
            \SY{believe; maintain; be of the view}
            \VI{\textit{cho rằng}, \textit{tin rằng}.}
            \EX{People hold the notion that cleaning brings luck at New Year.}
            \EX{Some still hold the notion that success is purely luck.}
            \CO{hold the notion/belief/idea that + clause}
            \end{ExplainCard}

            \begin{ExplainCard}{get rid of}{phrase}
            \EN{to remove, eliminate, or discard something unwanted.}
            \SY{eliminate; dispose of; cast off}
            \VI{\textit{loại bỏ}, \textit{vứt bỏ}.}
            \EX{We clean the house to get rid of bad luck.}
            \EX{She got rid of old clothes before moving.}
            \CO{get rid of clutter/habits/pests}
            \end{ExplainCard}

            \begin{ExplainCard}{Believe it or not}{discourse}
            \EN{used to introduce surprising but true information.}
            \SY{surprisingly; amazingly; odd as it sounds}
            \VI{\textit{tin hay không thì tuỳ}, nhưng đó là sự thật.}
            \EX{Believe it or not, the market is open all night on New Year’s Eve.}
            \EX{Believe it or not, he cooked the family’s first meal.}
            \CO{Believe it or not, + clause}
            \end{ExplainCard}

            \begin{ExplainCard}{bring (good) fortune}{phrase}
            \EN{to cause luck or prosperity to come; \textit{natural collocation:} \textbf{bring good fortune}, not “much fortune.”}
            \SY{bring luck; usher in prosperity; be auspicious}
            \VI{\textit{mang lại may mắn/thịnh vượng}.}
            \EX{Red envelopes are believed to bring good fortune.}
            \EX{They chose an auspicious hour to bring fortune to the family.}
            \CO{bring good fortune; good fortune to/for}
            \end{ExplainCard}

            \begin{ExplainCard}{strengthen the bond}{phrase}
            \EN{to make a relationship closer and more secure.}
            \SY{deepen ties; cement the relationship; tighten the bond}
            \VI{\textit{thắt chặt mối quan hệ}.}
            \EX{Holiday meals strengthen the bond between generations.}
            \EX{Volunteering together strengthened our bond.}
            \CO{strengthen/cement bonds; strong family bonds}
            \end{ExplainCard}

            \begin{ExplainCard}{bonding time}{n}
            \EN{time spent together that develops closeness and trust.}
            \SY{quality time; together time; connection time}
            \VI{\textit{thời gian gắn kết}.}
            \EX{Tet gives working parents precious bonding time with kids.}
            \EX{We schedule weekly bonding time after dinner.}
            \CO{have/make bonding time; family bonding time}
            \end{ExplainCard}
        \end{VocabExplain}
    ...
    \end{qa}
        ...
        \begin{VocabExplain}[Part 3]
            ...
            \EN{connected with religion or belief in a god or gods.}
            \SY{spiritual; faith-based}
            \VI{\textit{thuộc tôn giáo}.}
            \EX{Many religious festivals fall in spring.}
            \EX{He comes from a deeply religious family.}
            \CO{religious festival/ritual/belief}
            \end{ExplainCard}

            \begin{ExplainCard}{worship}{n/v}
            \EN{the act of showing reverence and adoration for a deity; to show such reverence.}
            \SY{reverence; veneration}
            \VI{\textit{sự thờ phụng}; \textit{thờ cúng}.}
            \EX{Thousands attended the dawn worship.}
            \EX{Families worship their ancestors at New Year.}
            \CO{place of worship; ancestor worship; worship at}
            \end{ExplainCard}

            \begin{ExplainCard}{sacred symbol}{n}
            \EN{an object or image regarded with holy or spiritual significance.}
            \SY{holy emblem; hallowed sign}
            \VI{\textit{biểu tượng linh thiêng}.}
            \EX{The lotus is a sacred symbol in many Asian cultures.}
            \EX{Soldiers’ memorials serve as sacred symbols of sacrifice.}
            \CO{regard as a sacred symbol; sacred symbol of}
            \end{ExplainCard}

            \begin{ExplainCard}{mellow out}{phr.v}
            \EN{to relax; to become calm and less tense.}
            \SY{unwind; chill out}
            \VI{\textit{thư giãn}, dịu lại.}
            \EX{Music helps crowds mellow out after the parade.}
            \EX{I mellow out with tea and folk songs at Tet.}
            \CO{mellow out with/after}
            \end{ExplainCard}

            \begin{ExplainCard}{urbanite}{n}
            \EN{a person who lives in a city or town.}
            \SY{city dweller; townsman}
            \VI{\textit{người thành thị}.}
            \EX{Urbanites often crave green, open spaces.}
            \EX{Festivals let urbanites reconnect with tradition.}
            \CO{young urbanites; urbanite lifestyle}
            \end{ExplainCard}

            \begin{ExplainCard}{rat race}{n}
            \EN{the exhausting, competitive struggle of modern life and work.}
            \SY{grind; treadmill}
            \VI{\textit{cuộc sống bon chen}.}
            \EX{Festivals offer a break from the rat race.}
            \EX{He quit the rat race to move home.}
            \CO{escape/leave the rat race}
            \end{ExplainCard}

            \begin{ExplainCard}{acknowledge}{v}
            \EN{to admit or accept that something is true; to recognize.}
            \SY{admit; recognize}
            \VI{\textit{thừa nhận}; \textit{công nhận}.}
            \EX{She acknowledged that customs change over time.}
            \EX{We must acknowledge volunteers’ efforts.}
            \CO{readily acknowledge; acknowledge the fact that}
            \end{ExplainCard}

            \begin{ExplainCard}{festivities}{n}
            \EN{celebrations and enjoyable activities during a festival or special event.}
            \SY{celebrations; merrymaking}
            \VI{\textit{các hoạt động lễ hội/vui chơi}.}
            \EX{Street festivities lasted all night.}
            \EX{Join the festivities in the main square.}
            \CO{festival festivities; join/enjoy the festivities}
            \end{ExplainCard}

            \begin{ExplainCard}{uphold the traditions}{phrase}
            \EN{to maintain and support long-standing customs.}
            \SY{preserve; keep alive}
            \VI{\textit{giữ gìn truyền thống}.}
            \EX{Elders uphold the traditions through storytelling.}
            \EX{The village upholds the traditions every spring.}
            \CO{uphold traditions/values}
            \end{ExplainCard}

            \begin{ExplainCard}{well-preserved}{adj}
            \EN{kept in good condition; protected from decay or loss.}
            \SY{well-kept; conserved}
            \VI{\textit{được gìn giữ tốt}.}
            \EX{The chant’s melody is remarkably well-preserved.}
            \EX{A well-preserved pagoda stands on the hill.}
            \CO{well-preserved heritage/artefact/custom}
            \end{ExplainCard}

            \begin{ExplainCard}{transition}{n}
            \EN{a change from one state or condition to another.}
            \SY{shift; transformation}
            \VI{\textit{sự chuyển đổi}.}
            \EX{Globalisation speeds the transition of festival meanings.}
            \EX{The transition was smooth thanks to clear rules.}
            \CO{transition from A to B; period of transition}
            \end{ExplainCard}

            \begin{ExplainCard}{adopt}{v}
            \EN{to take up or start using something new (idea, custom, practice).}
            \SY{embrace; take on}
            \VI{\textit{tiếp nhận}, \textit{áp dụng}.}
            \EX{Young people adopted the lantern parade quickly.}
            \EX{Some towns adopt digital ticketing for festivals.}
            \CO{adopt a custom/policy/practice}
            \end{ExplainCard}

            \begin{ExplainCard}{quaint}{adj}
            \EN{attractively old-fashioned or unusual.}
            \SY{picturesque; old-world}
            \VI{\textit{cổ kính}, \textit{mộc mạc đáng yêu}.}
            \EX{Visitors love the town’s quaint rituals.}
            \EX{A quaint market springs up every New Year.}
            \CO{quaint custom/village/streets}
            \end{ExplainCard}

            \begin{ExplainCard}{socially acceptable}{adj}
            \EN{considered appropriate by most people in a society.}
            \SY{appropriate; respectable}
            \VI{\textit{được xã hội chấp nhận}.}
            \EX{New dances are fine if they’re socially acceptable.}
            \EX{The costume tweaks remain socially acceptable.}
            \CO{deem/consider socially acceptable}
            \end{ExplainCard}

            \begin{ExplainCard}{taboo}{n}
            \EN{a social or cultural prohibition or strong disapproval.}
            \SY{prohibition; no-no}
            \VI{\textit{điều cấm kỵ}.}
            \EX{Breaking food taboos offends elders.}
            \EX{They avoid topics that are still taboos.}
            \CO{cultural/religious taboo; break a taboo}
            \end{ExplainCard}

            \begin{ExplainCard}{spoil}{v}
            \EN{to damage the value or enjoyment of something.}
            \SY{ruin; mar}
            \VI{\textit{làm hỏng}, \textit{phá hỏng}.}
            \EX{Litter can spoil the festive atmosphere.}
            \EX{Rain didn’t spoil the fireworks this year.}
            \CO{spoil the mood/occasion/view}
            \end{ExplainCard}

            \begin{ExplainCard}{decent}{adj}
            \EN{good enough; of a satisfactory or respectable standard.}
            \SY{respectable; acceptable}
            \VI{\textit{khá tốt}, \textit{tươm tất}.}
            \EX{A decent parade draws families downtown.}
            \EX{They found a decent venue for the fair.}
            \CO{decent turnout/standard/venue}
            \end{ExplainCard}

            \begin{ExplainCard}{honourable}{adj}
            \EN{deserving respect; morally right.}
            \SY{noble; reputable}
            \VI{\textit{đáng kính}, \textit{cao quý}.}
            \EX{It’s honourable to keep promises to ancestors.}
            \EX{They followed an honourable tradition of charity.}
            \CO{honourable tradition/intention}
            \end{ExplainCard}

            \begin{ExplainCard}{pass on}{phr.v}
            \EN{to give or teach something to the next person or generation.}
            \SY{hand down; transmit}
            \VI{\textit{truyền lại}, \textit{trao lại}.}
            \EX{Elders pass on folk songs to children.}
            \EX{We pass on baking rituals each New Year.}
            \CO{pass on knowledge/customs/stories}
            \end{ExplainCard}

            \begin{ExplainCard}{a breath of fresh air}{idiom}
            \EN{a welcome change that is new, lively, and refreshing.}
            \SY{welcome change; refreshment}
            \VI{\textit{làn gió mới}.}
            \EX{The night market is a breath of fresh air downtown.}
            \EX{New artists brought a breath of fresh air to the show.}
            \CO{bring/be a breath of fresh air}
            \end{ExplainCard}

            \begin{ExplainCard}{publicity}{n}
            \EN{public attention and notice; activity to make something known.}
            \SY{exposure; promotion}
            \VI{\textit{sự công khai/chú ý của công chúng}; \textit{quảng bá}.}
            \EX{TV gave the festival huge publicity.}
            \EX{They ran a publicity campaign before Tet.}
            \CO{gain/attract publicity; publicity campaign}
            \end{ExplainCard}

            \begin{ExplainCard}{double-edged sword}{idiom}
            \EN{something that has both benefits and drawbacks.}
            \SY{mixed blessing; two-edged blade}
            \VI{\textit{con dao hai lưỡi}.}
            \EX{Social media is a double-edged sword for festivals.}
            \EX{Free entry can be a double-edged sword—crowds swell.}
            \CO{prove/turn out to be a double-edged sword}
            \end{ExplainCard}

            \begin{ExplainCard}{disseminate}{v}
            \EN{to spread information, ideas, or images widely.}
            \SY{circulate; broadcast}
            \VI{\textit{phổ biến}, \textit{lan truyền}.}
            \EX{Broadcasters disseminate safety guidelines.}
            \EX{Clips disseminated rapidly across platforms.}
            \CO{disseminate information/images/knowledge}
            \end{ExplainCard}

            \begin{ExplainCard}{vivid}{adj}
            \EN{clear, detailed, and lifelike; intensely bright or strong.}
            \SY{graphic; striking}
            \VI{\textit{sinh động}, \textit{rực rỡ}.}
            \EX{The film shows vivid scenes of the parade.}
            \EX{Vivid lanterns lit the riverbank.}
            \CO{vivid memory/image/colour}
            \end{ExplainCard}

            \begin{ExplainCard}{exquisite}{adj}
            \EN{extremely beautiful and delicate; finely made.}
            \SY{elegant; superb}
            \VI{\textit{tuyệt đẹp}, \textit{tinh xảo}.}
            \EX{Her áo dài featured exquisite embroidery.}
            \EX{The temple carvings are exquisitely detailed.}
            \CO{exquisite beauty/craftsmanship}
            \end{ExplainCard}

            \begin{ExplainCard}{instructive}{adj}
            \EN{useful and informative; teaching something valuable.}
            \SY{educational; enlightening}
            \VI{\textit{mang tính giáo dục}, \textit{bổ ích}.}
            \EX{The documentary was instructive for children.}
            \EX{Guided tours provide instructive context.}
            \CO{highly instructive; instructive example}
            \end{ExplainCard}

            \begin{ExplainCard}{alien (culture)}{adj}
            \EN{foreign and unfamiliar; different from what is normal locally.}
            \SY{foreign; unfamiliar}
            \VI{\textit{xa lạ}, \textit{ngoại lai}.}
            \EX{Some find the costumes alien at first.}
            \EX{Alien cultures meet at international fairs.}
            \CO{alien concept/culture/environment}
            \end{ExplainCard}

            \begin{ExplainCard}{telly}{n, BrE informal}
            \EN{television.}
            \SY{TV; the box}
            \VI{\textit{tivi} (khẩu ngữ Anh-Anh).}
            \EX{We watched the fireworks on the telly.}
            \EX{Turn off the telly and join the street show!}
            \CO{on the telly; telly programme}
            \end{ExplainCard}

            \begin{ExplainCard}{real-world}{adj}
            \EN{relating to actual experience rather than theory or simulation.}
            \SY{practical; hands-on}
            \VI{\textit{thực tế}, ngoài đời.}
            \EX{Street festivals give real-world cultural experience.}
            \EX{Real-world practice beats classroom theory.}
            \CO{real-world experience/setting/application}
            \end{ExplainCard}

            \begin{ExplainCard}{profound}{adj}
            \EN{very great or intense; showing deep insight.}
            \SY{deep; far-reaching}
            \VI{\textit{sâu sắc}, \textit{to lớn}.}
            \EX{Globalisation has a profound impact on rituals.}
            \EX{The speech left a profound impression.}
            \CO{profound impact/change/insight}
            \end{ExplainCard}

            \begin{ExplainCard}{exemplify}{v}
            \EN{to serve as a typical example of; to illustrate.}
            \SY{illustrate; typify}
            \VI{\textit{minh hoạ}, \textit{làm ví dụ}.}
            \EX{This parade exemplifies cultural blending.}
            \EX{Her story exemplifies community spirit.}
            \CO{exemplify a trend/principle}
            \end{ExplainCard}

            \begin{ExplainCard}{cultural assimilation}{n}
            \EN{the process by which one group adopts the culture of another, often the dominant group.}
            \SY{absorption; acculturation}
            \VI{\textit{hoà nhập văn hoá/đồng hoá}.}
            \EX{Rapid cultural assimilation can dilute local customs.}
            \EX{Schools study immigrant cultural assimilation.}
            \CO{process/degree of cultural assimilation}
            \end{ExplainCard}

            \begin{ExplainCard}{cultural interference}{n}
            \EN{disruptive external influence that alters or distorts a local culture.}
            \SY{intrusion; cultural encroachment}
            \VI{\textit{sự can thiệp văn hoá} (gây xáo trộn).}
            \EX{Unfiltered imports may cause cultural interference.}
            \EX{Tourism without context risks cultural interference.}
            \CO{avoid/minimise cultural interference}
            \end{ExplainCard}

            \begin{ExplainCard}{erode}{v}
            \EN{to gradually wear away or diminish.}
            \SY{wear down; undermine}
            \VI{\textit{bào mòn}, \textit{suy giảm}.}
            \EX{Commercialism can erode festival meaning.}
            \EX{Trust eroded after the scandal.}
            \CO{erode traditions/values/confidence}
            \end{ExplainCard}

            \begin{ExplainCard}{abandon}{v}
            \EN{to leave behind or stop doing something permanently.}
            \SY{discard; give up}
            \VI{\textit{bỏ rơi}, \textit{bỏ hẳn}.}
            \EX{Some villages abandoned the old procession.}
            \EX{They refused to abandon their dialect songs.}
            \CO{abandon a practice/custom/plan}
            \end{ExplainCard}
        \end{VocabExplain}

    \begin{VocabHighlights}
        \VH{to assert social status}{(phrase) to show off how powerful you are}{(cụm từ) thể hiện, nhấn mạnh địa vị xã hội}
        \VH{exorbitant}{(adj) (of a price) much too high}{(tính từ) (thuộc về giá cả) quá cao}
        \VH{beyond one’s means}{(idiom) too costly for one}{(thành ngữ) quá đắt đỏ}
        \VH{to attach great importance to}{(phrase) to regard something/somebody highly}{(cụm từ) coi là quan trọng}
        \VH{to be dressed to kill}{(idiom) to be dressed up}{(thành ngữ) ăn mặc đẹp}
        \VH{to come cheap}{(idiom) to be cheap}{(thành ngữ) có giá rẻ}
        \VH{a slave to fashion}{(idiom) a person who is particularly concerned about his or her clothing}{(thành ngữ) người quá quan trọng cách ăn mặc}
        \VH{killer fashion taste}{(phrase) top-notch fashion style}{(cụm từ) gu thời trang tuyệt đỉnh}
        \VH{to be averse to}{(adj) not liking something or wanting to do something; opposed to doing something}{(tính từ) có ác cảm với}
        \VH{revealing}{(adj) allowing more of somebody’s body to be seen than usual}{(tính từ) hở hang}
        \VH{lithe}{(adj) moving or bending easily, in a way that is elegant}{(tính từ) uyển chuyển}
        \VH{grace}{(n) an attractive quality of movement that is smooth, elegant and controlled}{(danh từ) sự duyên dáng}
        \VH{to show off}{(phr.v) to make somebody look attractive, by showing their best features}{(cụm động từ) khoe khoang}
        \VH{if my memory serves me correctly}{(phrase) if I remember correctly}{(cụm từ) nếu tôi nhớ đúng thì}
        \VH{bell-bottoms}{(n) trousers/pants with legs that become very wide below the knee}{(danh từ) quần ống loe}
        \VH{to be on trend}{(idiom) to be fashionable}{(thành ngữ) hợp mốt}
        \VH{to speak volumes (about)}{(idiom) convey a great deal}{(thành ngữ) truyền tải được nhiều}
        \VH{to project one’s wealth}{(phrase) to show off how rich you are}{(cụm từ) phô trương sự giàu có}
        \VH{mediocre}{(adj) not very good}{(tính từ) không tốt lắm, xoàng}
        \VH{poverty-stricken}{(adj) extremely poor; with very little money}{(tính từ) cực kỳ nghèo đói}
        \VH{the bulk of}{(phrase) most of something}{(cụm từ) đa phần}
        \VH{fancy}{(adj) decorative or complicated, expensive}{(tính từ) đắt đỏ, cầu kỳ}
        \VH{off the peg}{(adj) readily-made}{(tính từ) có sẵn, không cần đặt}
        \VH{to undergo}{(v) to experience something that is unpleasant or something that involves a change}{(động từ) trải qua}
        \VH{predominantly}{(adv) mostly or mainly}{(trạng từ) chiếm đa số}
        \VH{plentiful}{(adj) plenty and abundant}{(tính từ) nhiều}
        \VH{to date back to}{(phrase) to have existed for a particular length of time}{(cụm từ) có từ thời, có từ ngày}
        \VH{to give somebody a hand}{(idiom) to help someone}{(thành ngữ) giúp đỡ}
        \VH{to hold a notion}{(phrase) to keep a belief}{(cụm từ) giữ một quan điểm}
        \VH{to get rid of}{(idiom) to remove or throw away something unwanted}{(thành ngữ) từ bỏ}
        \VH{believe it or not}{(idiom) said when telling someone about something that is true, although it seems unlikely}{(thành ngữ) nghe khó tin nhưng sự thật là}
        \VH{to bring much fortune}{(phrase) earn much money}{(cụm từ) kiếm được nhiều tiền}
        \VH{to strengthen the bond}{(phrase) to have a closer relationship by doing something together}{(cụm từ) thắt chặt tình cảm}
        \VH{bonding time}{(phrase) time the family spends together meaningfully}{(cụm từ) thời gian gắn kết gia đình}
        \VH{religious}{(adj) believing strongly in a particular religion and obeying its laws and practices}{(tính từ) thuộc về tôn giáo, tín ngưỡng}
        \VH{worship}{(n) the practice of showing respect for god or a god, by saying prayers, singing with others, etc}{(danh từ) sự thờ cúng, tôn sùng}
        \VH{sacred symbols}{(noun) symbols considered to be holy}{(danh từ) các biểu tượng thiêng liêng}
        \VH{to mellow out}{(phr.v) to become detached from worry, strife, stress, etc}{(cụm động từ) hết lo lắng}
        \VH{urbanite}{(n) city dweller}{(danh từ) cư dân thành phố}
        \VH{a/the rat race}{(idiom) an exhausting, usually competitive routine}{(thành ngữ) cuộc sống bận rộn, đầy cạnh tranh, mệt mỏi}
        \VH{to acknowledge}{(v) to accept that something is true}{(động từ) thừa nhận}
        \VH{festivities}{(n) the activities that are organized to celebrate a special event}{(danh từ) hoạt động lễ hội}
        \VH{to uphold the traditions}{(phrase) to remain the tradition}{(cụm từ) giữ gìn truyền thống}
        \VH{well-preserved}{(adj) having remained in good condition}{(tính từ) được bảo tồn ở tình trạng tốt}
        \VH{transition}{(n) the process or a period of changing from one state or condition to another}{(danh từ) sự thay đổi}
        \VH{to adopt}{(v) to accept or start to use something new}{(động từ) áp dụng}
        \VH{quaint}{(adj) attractive in an unusual or old-fashioned way}{(tính từ) cổ điển, kỳ lạ}
        \VH{socially acceptable}{(phrase) to be accepted in society}{(cụm từ) được xã hội chấp nhận}
        \VH{taboo}{(n) a general agreement not to do something or talk about something}{(danh từ) điều kiêng kị}
        \VH{to spoil}{(v) to change something good into something bad, unpleasant, useless, etc}{(động từ) làm hỏng, phá huỷ}
        \VH{decent}{(adj) acceptable to people in particular}{(tính từ) phù hợp}
        \VH{honourable}{(adj) deserving respect and admiration}{(tính từ) đáng tôn kính}
        \VH{to pass on}{(v) to hand down generations}{(động từ) truyền từ đời này qua đời khác}
        \VH{a breath of fresh air}{(idiom) someone or something that is new and different and make everything seem more exciting}{(thành ngữ) một điều mới mẻ}
        \VH{publicity}{(n) the business of attracting the attention of the public to something/somebody; the things that are done to attract attention}{(danh từ) sự quảng bá, công khai tới công chúng}
        \VH{a double-edged sword}{(idiom) a situation or course of action having both positive and negative effects}{(thành ngữ) con dao hai lưỡi (mặt tốt và xấu của 1 vấn đề)}
        \VH{to disseminate}{(v) to spread information, knowledge, etc. so that it reaches many people}{(động từ) truyền bá (thông tin, hình ảnh,...)}
        \VH{vivid}{(adj) very bright}{(tính từ) tươi sáng}
        \VH{exquisite}{(adj) extremely beautiful or carefully made}{(tính từ) tinh tế, rất đẹp}
        \VH{instructive}{(adj) giving a lot of useful information}{(tính từ) cung cấp thông tin có ích}
        \VH{alien}{(adj) from another country or society; foreign}{(tính từ) từ một xã hội, quốc gia khác}
        \VH{telly}{(n) the programmes broadcast on television}{(danh từ) tivi, chương trình truyền hình}
        \VH{profound}{(a) very great, strongly}{(tính từ) to lớn, mạnh mẽ}
        \VH{exemplified}{(p2) to be a typical example of something}{(phân từ 2) là ví dụ điển hình của}
        \VH{cultural assimilation}{(noun) the process in which a minority group or culture comes to resemble a dominant group or assume the values, behaviors, and beliefs of another group}{(danh từ) sự đồng hoá văn hoá}
        \VH{cultural interference}{(phrase) the contact and exchange of culture}{(cụm từ) sự giao thoa văn hoá}
        \VH{eroded}{(p2) to be gradually destroyed or be made weaker over a period of time}{(phân từ 2) bị làm xói mòn}
        \VH{abandoned}{(p2) left and no longer wanted, used or needed}{(phân từ 2) bị xoá bỏ}
    \end{VocabHighlights}
